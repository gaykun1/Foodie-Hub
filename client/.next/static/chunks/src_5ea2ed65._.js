...
const CheckoutForm = ({ order, shipping, setShipping })=>{
    _s();
    const { register, getValues, formState: { errors } } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hook$2d$form$2f$dist$2f$index$2e$esm$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useForm"])();
    ...
    const usePromocode = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "CheckoutForm.useCallback[usePromocode]": async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/promocode/promocodes/${promocode}/use`, {}, {
    ...
    }["CheckoutForm.useCallback[usePromocode]"], [
        promocode
    ]);
    ...
    const getClientSecret = async ()=>{
        try {
            if (order) {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/payment/payment-intent`, {
    ...
    const placeOrder = async ()=>{
        ...
        if (order) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/order/orders`, {
                formData,
                percent: discount,
                shipping,
                cartId: cart?._id,
...
_s(CheckoutForm, "SOxQrbIXE+YrwhiHc2fesVWgFKo=", false, function() {
    return [
...
const Page = ()=>{
    _s();
    const [shipping, setShipping] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$reduxTypes$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Shipping"].Economy);
    ...
    const getOrder = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[getOrder]": async ()=>{
            try {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/order/orders/${id}`, {
                    withCredentials: true
                });
                if (res.data) {
                    setOrder(res.data);
...
_s(Page, "nDKwxPab5X38x/OeThAB3uZC/U4=", false, function() {
    return [
...
//# sourceMappingURL=src_5ea2ed65._.js.map