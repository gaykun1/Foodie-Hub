...
"[project]/src/components/job/ApplicationForm.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const ApplicationForm = ()=>{
    ...
    const onSubmit = async (data)=>{
        try {
            setLoading(true);
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/courier/applications`, {
                data
            }, {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["isAxiosError"])(err) && err.response) {
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].isAxiosError(err) && err.response) console.log(err.response.data);
            }
        } finally{
            setLoading(false);
        }
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ApplicationForm.useEffect": ()=>{
            const checkIfSent = {
                "ApplicationForm.useEffect.checkIfSent": async ()=>{
                    try {
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/courier/applications/status`, {
                            withCredentials: true
                        });
                        setAlreadySent(res.data.status);
                    } catch (err) {
            ...
            }["ApplicationForm.useEffect.checkIfSent"];
            checkIfSent();
        }
    }["ApplicationForm.useEffect"], []);
...
//# sourceMappingURL=_2f373196._.js.map