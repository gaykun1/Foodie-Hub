...
const OrderCardDashboard = ({ order, setOrders })=>{
    ...
    const toggleToPreparing = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch("http://localhost:5200/api/order/toggle-to-preparing", {
                id: order._id
            }, {
...
const Page = ()=>{
    ...
    const getCreatedOrders = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5200/api/order/get-created-orders/${user?.restaurantId}`, {
                withCredentials: true
            });
            if (res.data) {
                setOrders(res.data);
