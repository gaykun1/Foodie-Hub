...
function HeaderRestaurant() {
        ...
        "HeaderRestaurant.useEffect": ()=>{
            const getRestaurantInfo = {
                "HeaderRestaurant.useEffect.getRestaurantInfo": async ()=>{
                    try {
                        setIsLoading(true);
                        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/restaurant/restaurants/${id}`);
    ...
    const toggleFavourite = async ()=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/restaurant/restaurants/${id}/favourite`, {}, {
                withCredentials: true
            });
...
//# sourceMappingURL=src_1f2c11cf._.js.map