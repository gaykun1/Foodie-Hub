...
"[project]/src/app/(restaurant)/restaurant/menu/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    const getDishes = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "Page.useCallback[getDishes]": async ()=>{
            try {
                ...
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/restaurant/dishes/${id}`);
...
_s(Page, "Tww5mbBAoPJIMsu/rz3YYWeNbpw=", false, function() {
    return [
...
//# sourceMappingURL=src_bc20f934._.js.map