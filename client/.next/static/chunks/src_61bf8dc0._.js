...
"[project]/src/components/CourierOrderCard.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const CourierOrderCard = ({ order, checkIfHasOrder, setViewDetails })=>{
    ...
    }["CourierOrderCard.useAppSelector"]);
    ...
    }["CourierOrderCard.useCallback[takeOrder]"], []);
    ...
    const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CourierOrderCard.useMemo[date]": ()=>new Date(order.createdAt).toDateString()
    }["CourierOrderCard.useMemo[date]"], [
        order.createdAt
    ]);
...
_s(CourierOrderCard, "zELoZ9IfkN/Oz+V6/P86FqqFkH8=", false, function() {
    return [
...
var _c;
__turbopack_context__.k.register(_c, "CourierOrderCard");
...
"[project]/src/app/(main)/courier/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/polyfills/process.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$CourierOrderCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/CourierOrderCard.tsx [app-client] (ecmascript)");
...
const Page = ()=>{
    ...
    const getFreeOrders = async ()=>{
        try {
            if (courier) {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/order/free-orders/${courier.city}`, {
                    withCredentials: true
                });
    ...
    const getYourOrders = async ()=>{
        try {
            if (courier) {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/order/couriers/${courier._id}/orders`, {
                    withCredentials: true
                });
                if (res.data) {
    ...
    const checkIfHasOrder = async ()=>{
        try {
            if (courier) {
                const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/courier/orders/${courier._id}/status`);
    ...
    const toggleOrderStatus = async (status, id)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].patch(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/courier/orders/${id}/status`, {
                status: status
            }, {
                withCredentials: true
            });
            ...
            const interval = setInterval({
                "Page.useEffect.interval": ()=>{
                    navigator.geolocation.getCurrentPosition({
                        ...
                        "Page.useEffect.interval": (err)=>console.error(err)
                    }["Page.useEffect.interval"], {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: freeOrders && freeOrders.length > 0 ? freeOrders?.map((order, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "",
...
_s(Page, "xN/+czYq+51/SflXxcSoKTvInIY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$reduxHooks$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppSelector"]
    ];
});
...
//# sourceMappingURL=src_61bf8dc0._.js.map