...
"[project]/node_modules/next/dist/compiled/postcss-modules-scope/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
    ...
    var e = {
        ...
        361: (e, t, r)=>{
            ...
            function getSingleLocalNamesForComposes(e) {
                return e.nodes.map((t)=>{
                    if (t.type !== "selector" || t.nodes.length !== 1) {
                        throw new Error(`composition is only allowed when selector is single :local class name not in "${e}"`);
                    }
                    t = t.nodes[0];
                    if (t.type !== "pseudo" || t.value !== ":local" || t.nodes.length !== 1) {
                        throw new Error('composition is only allowed when selector is single :local class name not in "' + e + '", "' + t + '" is weird');
                    }
                    t = t.first;
                    ...
                    Once (e, { rule: o }) {
                        ...
                        function localizeNode(e) {
                            switch(e.type){
                                ...
                                case "class":
                                    return n.className({
                                        value: exportScopedName(e.value, e.raws && e.raws.value ? e.raws.value : null)
                                    });
                                case "id":
                                    {
                                        return n.id({
                            ...
                            throw new Error(`${e.type} ("${e}") is not allowed in a :local block`);
                        }
                            ...
                            switch(e.type){
                                case "pseudo":
                                    if (e.value === ":local") {
                                        ...
                                        const r = e.next();
                                        if (r && r.type === "combinator" && r.value === " " && /\\[A-F0-9]{1,6}$/.test(t.last.value)) {
                                            t.last.spaces.after = " ";
                                        }
                                        e.replaceWith(t);
                                        return;
                            ...
                            e.walkDecls(/composes|compose-with/i, (e)=>{
                                ...
                                n.forEach((t)=>{
                                    ...
                                    if (n) {
                                        ...
                                        throw e.error(`referenced class name "${t}" in ${e.prop} not found`);
                                    }
                                });
                                e.remove();
                            });
            ...
            plugin.generateScopedName = function(e, t) {
                const r = t.replace(/\.[^./\\]+$/, "").replace(/[\W_]+/g, "_").replace(/^_|_$/g, "");
        ...
        969: (e, t, r)=>{
            ...
            var T = (b = {}, b[y.space] = true, b[y.cr] = true, b[y.feed] = true, b[y.newline] = true, b[y.tab] = true, b);
            ...
            var O = function() {
                        ...
                        switch(c[_.FIELDS.TYPE]){
                            case y.space:
                                ...
                                if (a) {
                                    ...
                                    var d = (0, S.getProp)(n, "raws", "spaces", a, "after") || null;
                                    if (d) {
                            ...
                            case y.word:
                                if (p && this.content(p) === "|" && e[i + 2] && e[i + 2][_.FIELDS.TYPE] !== y.equals && !n.operator && !n.namespace) {
                                    ...
                                    a = "attribute";
                                } else if (!n.value && n.value !== "" || a === "value" && !u) {
                                    var w = (0, S.unesc)(f);
                            ...
                            case y.str:
                                ...
                                var k = (0, l.unescapeValue)(f), P = k.unescaped, E = k.quoteMark;
                                n.value = P;
                                n.quoteMark = E;
                                a = "value";
                                (0, S.ensureObject)(n, "raws");
                ...
                e.combinator = function combinator() {
                    ...
                    if (this.isNamedCombinator()) {
                        ...
                        this.position++;
                    } else if (T[this.currToken[_.FIELDS.TYPE]]) {} else if (!u) {
                        this.unexpected();
                    }
                    if (c) {
                        if (u) {
                            var f = this.convertWhitespaceNodesToSpace(u), l = f.space, p = f.rawSpace;
                            c.spaces.before = l;
                            c.rawSpaceBefore = p;
                        }
                    } else {
                        var d = this.convertWhitespaceNodesToSpace(u, true), v = d.space, g = d.rawSpace;
                        if (!g) {
                            g = v;
                        }
                        var S = {};
        ...
        382: (e, t, r)=>{
            ...
            var u = r(124);
            var c = /^('|")([^]*)\1$/;
            var f = u(function() {}, "Assigning an attribute a value containing characters that might need to be escaped is deprecated. " + "Call attribute.setValue() instead.");
            var l = u(function() {}, "Assigning attr.quoted is deprecated and has no effect. Assign to attr.quoteMark instead.");
                ...
                while(u < s){
                    ...
                    switch(f){
                        ...
                        case n.feed:
                            ...
                            }while (f === n.space || f === n.newline || f === n.tab || f === n.cr || f === n.feed)
                            T = n.space;
                            h = a;
                            p = g - o - 1;
                            c = g;
                        ...
                        case n.pipe:
                            ...
                            do {
                                g += 1;
                                f = r.charCodeAt(g);
                            }while (f === n.plus || f === n.greaterThan || f === n.tilde || f === n.pipe)
                            T = n.combinator;
                            h = a;
                            p = u - o;
                            c = g;
...
//# sourceMappingURL=node_modules_next_dist_compiled_postcss-modules-scope_index_f68eb51c.js.map