...
"[project]/node_modules/next/dist/compiled/@ampproject/toolbox-optimizer/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    var __webpack_modules__ = {
        ...
        8483: (e, t, r)=>{
            "use strict";
            const { DomTransformer: i, TRANSFORMATIONS_AMP_FIRST: n, TRANSFORMATIONS_PAIRED_AMP: s, TRANSFORMATIONS_MINIMAL: a, DEFAULT_CONFIG: o } = r(3338);
            const c = r(2547);
            e.exports = {
                create: (e = o)=>new i(e),
        ...
        859: (e, t, r)=>{
            ...
            function calculateHost({ ampUrlPrefix: e = i, ampRuntimeVersion: t, lts: r = false, rtv: s = false }) {
                if (r && s) {
        ...
        2412: (e, t, r)=>{
            ...
            const { AMP_CACHE_HOST: a, AMP_RUNTIME_CSS_PATH: o, AMP_VALIDATION_RULES_URL: c, appendRuntimeVersion: l } = r(8846);
            ...
            async function fetchComponentVersions_(e, t) {
                ...
                if (!s.ok) {
                    throw new Error(`Failed fetching latest component versions from ${i} with status: ${s.status}`);
                }
                return s.json();
            }
            ...
            async function fetchLatestRuntimeData_({ config: e, ampUrlPrefix: t, lts: r }, i = null) {
                let n;
                n = {
                ...
                if (!n.version && t !== a) {
                    e.log.error(`Could not download runtime version from ${t}. Falling back to ${a}`);
            ...
            async function fetchAmpRuntimeStyles_(e, t, r) {
                if (t && !isAbsoluteUrl_(t)) {
                    e.log.warn(`AMP runtime styles cannot be fetched from relative ampUrlPrefix, please use the 'ampRuntimeStyles' parameter to provide the correct runtime style. Falling back to latest v0.css on ${a}`);
                    t = a;
                ...
                if (!n) {
                    e.log.error(`Could not download ${i}. Falling back to latest v0.css.`);
                    if (t || r) {
        ...
        4949: (e, t, r)=>{
            const i = r(8653);
            const { createElement: n, appendChild: s, nextNode: a, firstChildByTag: o } = r(2547);
            const { URL: c } = r(7310);
            const { skipNodeAndChildren: l } = r(7041);
            const u = r(1150);
            const f = 60;
            const d = 100;
            const p = 30;
        ...
        8256: (e, t, r)=>{
            "use strict";
            const { move: i, insertText: n, appendChild: s, insertBefore: a, createDocType: o, createElement: c, firstChildByTag: l } = r(2547);
            const { AMP_FORMATS: u, AMP_TAGS: f } = r(8846);
            const d = "AMP";
            const p = "data-auto";
            const h = {
                AMP: [
        ...
        4975: (e, t, r)=>{
            "use strict";
            const { appendChild: i, createElement: n, hasAttribute: s, firstChildByTag: a, insertText: o } = r(2547);
        ...
        5557: (e, t, r)=>{
            "use strict";
            const { remove: i, appendChild: n, createElement: s, nextNode: a, firstChildByTag: o } = r(2547);
        ...
        6070: (e, t, r)=>{
            "use strict";
            const i = r(7199);
            const { appendChild: n, createElement: s, insertText: a, hasAttribute: o } = r(2547);
            const { isCustomElement: c } = r(9170);
            const l = "i-amp-";
                        ...
                        for (const [i, n] of Object.entries(this.attributeTransformations)){
                            if (o(e, i)) {
                                try {
                                    ...
                                    this.log.debug(`Cannot remove boilerplate. Failed transforming ${i}="${e.attribs[i]}".`, t);
        ...
        9464: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, insertBefore: n, createElement: s, appendChild: a } = r(2547);
            const { parseLayout: o, cssLength: c, calculateHeight: l, calculateWidth: u, calculateLayout: f, getLayoutClass: d, isLayoutSizeDefined: p, getLayoutSizeDefinedClass: h } = r(4056);
            const m = [
                "",
                "nodisplay",
                "fixed",
            ...
            function createIntrinsicSizer(e, t) {
                ...
                const i = s("img", {
                    ...
                    role: "presentation",
                    src: "data:image/svg+xml;base64," + Buffer.from(`<svg height="${t.numeral}" width="${e.numeral}" xmlns="http://www.w3.org/2000/svg" version="1.1"/>`).toString("base64")
                });
                a(r, i);
                return r;
            }
        ...
        5414: (e, t, r)=>{
            "use strict";
            const { nextNode: i, insertAfter: n, createElement: s, firstChildByTag: a, hasAttribute: o } = r(2547);
            const { findMetaViewport: c, findRuntimeScript: l } = r(7041);
            const { AMP_FORMATS: u, AMP_CACHE_HOST: f } = r(8846);
            const d = "bind";
        ...
        9433: (e, t, r)=>{
            ...
            const { remove: s, insertAfter: a, createElement: o, firstChildByTag: c, nextNode: l } = r(2547);
            const u = "intrinsic";
            const f = 320;
            class Markdown {
                constructor(e){
            ...
            class MinifyHtml {
                ...
                async minifyAmpScript(e) {
                    try {
                        ...
                        if (t.error) {
                            this.log.warn("Could not minify inline amp-script", e.data, `${t.error.name}: ${t.error.message}`);
                            return;
                        }
                        e.data = t.code;
                    } catch (e) {
        ...
        6037: (e, t, r)=>{
            "use strict";
            const { appendChild: i, createElement: n, hasAttribute: s, remove: a, insertAfter: o, nextNode: c, firstChildByTag: l } = r(2547);
            const { findMetaViewport: u, skipNodeAndChildren: f } = r(7041);
            const { isValidImageSrcURL: d } = r(3741);
            ...
            class OptimizeHeroImage {
                ...
                async transform(e, t) {
                    ...
                    let c = a.length;
                    if (c > r) {
                        this.log.warn(`Found ${c} hero elements on the page, but the maximum is set to ${r}. The limit can be configured via the 'maxHeroImage' parameter.`);
                        c = r;
                    }
                    const f = h(n);
                    for(let e = 0; e < c; e++){
        ...
        3842: (e, t, r)=>{
            "use strict";
            const { createElement: i, nextNode: n, insertAfter: s, firstChildByTag: a } = r(2547);
            const { findMetaViewport: o, skipNodeAndChildren: c } = r(7041);
        ...
        707: (e, t, r)=>{
            "use strict";
            const { appendChild: i, appendAll: n, hasAttribute: s, firstChildByTag: a } = r(2547);
        ...
        7185: (e, t, r)=>{
            "use strict";
            const { createElement: i, hasAttribute: n, firstChildByTag: s, insertAfter: a, insertBefore: o, remove: c } = r(2547);
            const { AMP_CACHE_HOST: l } = r(8846);
            const { findMetaViewport: u } = r(7041);
            const { calculateHost: f } = r(859);
        ...
        2079: (e, t, r)=>{
            "use strict";
            const { insertText: i, createElement: n, hasAttribute: s, firstChildByTag: a } = r(2547);
            const o = r(7595);
            const c = r(977);
            const l = r(8937);
            const u = new Set([
            ...
            class SeparateKeyframes {
                ...
                logInvalid(e, t) {
                    this.log_.warn(`Found invalid keyframe property '${t}' in '${e}' not moving to style[amp-keyframes]`);
                }
                isAmpStory(e) {
        ...
        4626: (e, t, r)=>{
            "use strict";
            const { hasAttribute: i, remove: n, createElement: s, insertBefore: a, nextNode: o, firstChildByTag: c } = r(2547);
            const { skipNodeAndChildren: l } = r(7041);
            const { isRenderDelayingExtension: u, isCustomElement: f } = r(9170);
            const { applyLayout: d } = r(9464);
                ...
                return new Body.Promise(function(i, a) {
                    ...
                    if (e.timeout) {
                        o = setTimeout(function() {
                            s = true;
                            a(new FetchError(`Response timeout while trying to fetch ${e.url} (over ${e.timeout}ms)`, "body-timeout"));
                        }, e.timeout);
                    }
                    t.on("error", function(t) {
                        if (t.name === "AbortError") {
                            ...
                            a(new FetchError(`Invalid response body while trying to fetch ${e.url}: ${t.message}`, "system", t));
                        }
                    });
                    ...
                    t.on("end", function() {
                        ...
                        try {
                            ...
                            a(new FetchError(`Could not create Buffer from response body for ${e.url}: ${t.message}`, "system", t));
                        }
                    });
                });
            }
                ...
                return new fetch.Promise(function(r, s) {
                    ...
                    if (c.timeout) {
                        m.once("socket", function(e) {
                            g = setTimeout(function() {
                                s(new FetchError(`network timeout at: ${c.url}`, "request-timeout"));
                                finalize();
                            }, c.timeout);
                        });
                    }
                    m.on("error", function(e) {
                        s(new FetchError(`request to ${c.url} failed, reason: ${e.message}`, "system", e));
                        finalize();
                    });
                    m.on("response", function(e) {
                        ...
                        if (fetch.isRedirect(e.statusCode)) {
                            ...
                            switch(c.redirect){
                                case "error":
                                    s(new FetchError(`uri requested responds with a redirect, redirect mode is set to error: ${c.url}`, "no-redirect"));
                                    finalize();
                                    return;
                                case "manual":
                                    if (n !== null) {
                                ...
                                case "follow":
                                    ...
                                    if (c.counter >= c.follow) {
                                        s(new FetchError(`maximum redirect reached at: ${c.url}`, "max-redirect"));
                                        finalize();
                                        return;
                                    }
                                    const i1 = {
        ...
        8937: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/cssnano-simple/index.js [app-rsc] (ecmascript)");
        },
        7330: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/lru-cache/index.js [app-rsc] (ecmascript)");
        },
        7595: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/postcss-safe-parser/safe-parse.js [app-rsc] (ecmascript)");
        },
        6794: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/terser/bundle.min.js [app-rsc] (ecmascript)");
        },
        2037: (e)=>{
            "use strict";
        ...
        977: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/node_modules/postcss/lib/postcss.js [app-rsc] (ecmascript)");
        },
        2781: (e)=>{
            "use strict";
        ...
        1576: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[externals]/string_decoder [external] (string_decoder, cjs)");
        },
        7310: (e)=>{
            "use strict";
...
//# sourceMappingURL=node_modules_next_dist_compiled_%40ampproject_toolbox-optimizer_index_c3df8e3b.js.map