...
"[project]/src/app/(profile)/profile/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const Page = ()=>{
    ...
    const [isEquals, setIsEquals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(true);
    const handleSave = async (data)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].patch(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/auth/profile`, {
                payload
            }, {
                withCredentials: true
            });
            if (res.data) dispatch((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$redux$2f$authSlice$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(res.data));
            setIsEditing(false);
        } catch (err) {
            console.error(err);
        }
...
//# sourceMappingURL=_a3815463._.js.map