...
"[project]/node_modules/next/dist/compiled/comment-json/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    var e = {
        ...
        534: (e, t, i)=>{
            const r = i(36);
            const { CommentArray: s, PREFIX_BEFORE: n, PREFIX_AFTER_PROP: a, PREFIX_AFTER_COLON: o, PREFIX_AFTER_VALUE: u, PREFIX_AFTER_COMMA: h, COLON: c, UNDEFINED: l } = i(281);
            const tokenize = (e)=>r.tokenize(e, {
                    comment: true,
                    loc: true
                });
            const p = [];
        ...
        470: (e, t, i)=>{
            const { isArray: r, isObject: s, isFunction: n, isNumber: a, isString: o } = i(504);
            const u = i(710);
            const { PREFIX_BEFORE_ALL: h, PREFIX_BEFORE: c, PREFIX_AFTER_PROP: l, PREFIX_AFTER_COLON: p, PREFIX_AFTER_VALUE: f, PREFIX_AFTER_COMMA: d, PREFIX_AFTER: m, PREFIX_AFTER_ALL: x, BRACKET_OPEN: D, BRACKET_CLOSE: E, CURLY_BRACKET_OPEN: v, CURLY_BRACKET_CLOSE: y, COLON: C, COMMA: S, EMPTY: A, UNDEFINED: F } = i(534);
            const g = /[\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g;
            const k = " ";
            const w = "\n";
            const b = "null";
            const BEFORE = (e)=>`${c}:${e}`;
            ...
            const join = (e, t, i)=>e ? t ? e + t.trim() + w + i : e.trimRight() + w + i : t ? t.trimRight() + w + i : A;
            ...
            const object_stringify = (e, t)=>{
                ...
                const iteratee = (t)=>{
                    ...
                    s += o || w + i;
                    s += quote(t) + process_comments(e, AFTER_PROP(t), i) + C + process_comments(e, AFTER_COLON(t), i) + k + r + process_comments(e, AFTER_VALUE(t), i);
                    n = process_comments(e, AFTER_COMMA(t), i);
                };
                o.forEach(iteratee);
                s += join(n, process_comments(e, m, i), i);
            ...
            e.exports = (e, t, i)=>{
                ...
                T = t;
                P = a;
                const o = is_primitive_object(e) ? JSON.stringify(e) : stringify("", {
                    "": e
                }, A);
                clean();
                return s(e) ? process_comments(e, h, A).trimLeft() + o + process_comments(e, x, A).trimRight() : o;
            };
        },
        504: (e, t)=>{
            function isArray(e) {
        ...
        36: function(e) {
            (function webpackUniversalModuleDefinition(t, i) {
                if ("TURBOPACK compile-time truthy", 1) e.exports = i();
                else {}
            })(this, function() {
                return function(e) {
                    var t = {};
                        ...
                        function getQualifiedElementName(e) {
                            ...
                            switch(e.type){
                                ...
                                case a.JSXSyntax.JSXMemberExpression:
                                    var s = e;
                                    t = getQualifiedElementName(s.object) + "." + getQualifiedElementName(s.property);
                                    break;
                                default:
                                    break;
                            }
                                    ...
                                    if (!r) {
                                        switch(t.length){
                                            ...
                                            case 3:
                                                ...
                                                break;
                                            default:
                                                i = i && !(n && !s.Character.isDecimalDigit(o.charCodeAt(0)));
                                                i = i && !(a && !s.Character.isHexDigit(o.charCodeAt(0)));
                                                break;
                                        }
                                    }
                                }
                            ...
                            JSXParser.prototype.parseComplexJSXElement = function(e) {
                                ...
                                while(!this.scanner.eof()){
                                    ...
                                    if (r.type === a.JSXSyntax.JSXClosingElement) {
                                        ...
                                        if (t.length > 0) {
                                            var o = this.finalize(e.node, new n.JSXElement(e.opening, e.children, e.closing));
                                            e = t[t.length - 1];
                                            e.children.push(o);
                                            t.pop();
                                        } else {
                    ...
                    function(e, t) {
                        ...
                        t.Character = {
                            ...
                            isIdentifierStart: function(e) {
                                return e === 36 || e === 95 || e >= 65 && e <= 90 || e >= 97 && e <= 122 || e === 92 || e >= 128 && i.NonAsciiIdentifierStart.test(t.Character.fromCodePoint(e));
                            },
                            isIdentifierPart: function(e) {
                                return e === 36 || e === 95 || e >= 65 && e <= 90 || e >= 97 && e <= 122 || e >= 48 && e <= 57 || e === 92 || e >= 128 && i.NonAsciiIdentifierPart.test(t.Character.fromCodePoint(e));
                            },
                    ...
                    function(e, t, i) {
                        ...
                        var l = function() {
                            ...
                            Parser.prototype.unexpectedTokenError = function(e, t) {
                                ...
                                if (e) {
                                    if (!t) {
                                        i = e.type === 2 ? n.Messages.UnexpectedEOS : e.type === 3 ? n.Messages.UnexpectedIdentifier : e.type === 6 ? n.Messages.UnexpectedNumber : e.type === 8 ? n.Messages.UnexpectedString : e.type === 10 ? n.Messages.UnexpectedTemplate : n.Messages.UnexpectedToken;
                                        if (e.type === 4) {
                                    ...
                                    case 7:
                                        switch(this.lookahead.value){
                                            ...
                                            case "/=":
                                                ...
                                                r = this.getTokenRaw(i);
                                                t = this.finalize(e, new a.RegexLiteral(i.regex, r, i.pattern, i.flags));
                                                break;
                                            default:
                            ...
                            Parser.prototype.parsePropertyMethodFunction = function() {
                                ...
                                return this.finalize(t, new a.FunctionExpression(null, r.params, s, e));
                            };
                            Parser.prototype.parsePropertyMethodAsyncFunction = function() {
                                ...
                                return this.finalize(e, new a.AsyncFunctionExpression(null, r.params, s));
                            };
                            ...
                            Parser.prototype.parseObjectProperty = function(e) {
                                ...
                                if (i.type === 3) {
                                    ...
                                    this.nextToken();
                                    u = this.match("[");
                                    l = !this.hasLineTerminator && p === "async" && !this.match(":") && !this.match("(") && !this.match("*") && !this.match(",");
                                    s = l ? this.parseObjectPropertyKey() : this.finalize(t, new a.Identifier(p));
                                } else if (this.match("*")) {
                                    this.nextToken();
                                } else {
                                    u = this.match("[");
                                ...
                                if (this.match(")")) {
                                    ...
                                    if (this.match("...")) {
                                        ...
                                        if (this.match(",")) {
                                            ...
                                            if (!r) {
                                                e = this.finalize(this.startNode(t), new a.SequenceExpression(s));
                                            }
                                        }
                                        if (!r) {
                                            this.expect(")");
                                            if (this.match("=>")) {
                                                ...
                                                if (!r) {
                                                    ...
                                                    var o = e.type === u.Syntax.SequenceExpression ? e.expressions : [
                                                        e
                                                    ];
                                                    e = {
                                                        type: c,
                            ...
                            Parser.prototype.parseLeftHandSideExpressionAllowCall = function() {
                                ...
                                while(true){
                                    if (this.match(".")) {
                                        ...
                                        this.expect(".");
                                        var s = this.parseIdentifierName();
                                        r = this.finalize(this.startNode(e), new a.StaticMemberExpression(r, s));
                                    } else if (this.match("(")) {
                                        ...
                                        this.expect("]");
                                        r = this.finalize(this.startNode(e), new a.ComputedMemberExpression(r, s));
                                    } else if (this.lookahead.type === 10 && this.lookahead.head) {
                                        var h = this.parseTemplateLiteral();
                                        r = this.finalize(this.startNode(e), new a.TaggedTemplateExpression(r, h));
                                    } else {
                                        break;
                                    }
                                }
                                ...
                                if (this.match("++") || this.match("--")) {
                                    ...
                                    if (!this.hasLineTerminator && this.lookahead.type === 7) {
                                        if (this.match("++") || this.match("--")) {
                                            ...
                                            var s = false;
                                            e = this.finalize(this.startNode(t), new a.UpdateExpression(o, e, s));
                                        }
                                    }
                                }
                                return e;
                            ...
                            Parser.prototype.parseExponentiationExpression = function() {
                                ...
                                if (t.type !== u.Syntax.UnaryExpression && this.match("**")) {
                                    ...
                                    t = this.finalize(this.startNode(e), new a.BinaryExpression("**", i, r));
                                }
                                return t;
                            };
                            ...
                            Parser.prototype.parseConditionalExpression = function() {
                                ...
                                if (this.match("?")) {
                                    ...
                                    t = this.finalize(this.startNode(e), new a.ConditionalExpression(t, r, s));
                                    this.context.isAssignmentTarget = false;
                                    this.context.isBindingElement = false;
                                }
                                return t;
                                ...
                                if (!this.context.allowYield && this.matchKeyword("yield")) {
                                    ...
                                    if (e.type === c || this.match("=>")) {
                                        ...
                                        if (o) {
                                            ...
                                            e = s ? this.finalize(d, new a.AsyncArrowFunctionExpression(o.params, m, D)) : this.finalize(d, new a.ArrowFunctionExpression(o.params, m, D));
                                        ...
                                        if (this.matchAssign()) {
                                            ...
                                            if (this.context.strict && e.type === u.Syntax.Identifier) {
                                                ...
                                                if (this.scanner.isRestrictedWord(E.name)) {
                                                    this.tolerateUnexpectedToken(i, n.Messages.StrictLHSAssignment);
                                                }
                                                if (this.scanner.isStrictModeReservedWord(E.name)) {
                                                    this.tolerateUnexpectedToken(i, n.Messages.StrictReservedWord);
                                                }
                                            }
                                            if (!this.match("=")) {
                                                this.context.isAssignmentTarget = false;
                                            ...
                                            i = this.nextToken();
                                            var v = i.value;
                                            var y = this.isolateCoverGrammar(this.parseAssignmentExpression);
                                            e = this.finalize(this.startNode(t), new a.AssignmentExpression(v, e, y));
                                            this.context.firstCoverInitializedNameError = null;
                                        }
                                    }
                                }
                            ...
                            Parser.prototype.parseLexicalBinding = function(e, t) {
                                ...
                                } else if (!t.inFor && s.type !== u.Syntax.Identifier || this.match("=")) {
                                    this.expect("=");
                                    o = this.isolateCoverGrammar(this.parseAssignmentExpression);
                                }
                            ...
                            Parser.prototype.parsePropertyPattern = function(e, t) {
                                ...
                                if (this.lookahead.type === 3) {
                                    ...
                                    if (this.match("=")) {
                                        ...
                                        u = this.finalize(this.startNode(h), new a.AssignmentPattern(c, l));
                                    } else if (!this.match(":")) {
                                        e.push(h);
                                        s = true;
                                        u = c;
                            ...
                            Parser.prototype.parsePatternWithDefault = function(e, t) {
                                ...
                                if (this.match("=")) {
                                    ...
                                    r = this.finalize(this.startNode(i), new a.AssignmentPattern(r, n));
                                }
                                return r;
                            };
                            ...
                            Parser.prototype.parseForStatement = function() {
                                ...
                                if (this.match(";")) {
                                    ...
                                    if (this.matchKeyword("var")) {
                                        ...
                                        if (l.length === 1 && this.matchKeyword("in")) {
                                            ...
                                            e = null;
                                        } else if (l.length === 1 && l[0].init === null && this.matchContextualKeyword("of")) {
                                            e = this.finalize(e, new a.VariableDeclaration(l, "var"));
                                            this.nextToken();
                                            s = e;
                                        ...
                                        if (!this.context.strict && this.lookahead.value === "in") {
                                            ...
                                            this.context.allowIn = c;
                                            if (l.length === 1 && l[0].init === null && this.matchKeyword("in")) {
                                ...
                                return typeof s === "undefined" ? this.finalize(h, new a.ForStatement(e, t, i, x)) : r ? this.finalize(h, new a.ForInStatement(s, o, x)) : this.finalize(h, new a.ForOfStatement(s, o, x));
                            };
                                ...
                                if (t.type === u.Syntax.Identifier && this.match(":")) {
                                    ...
                                    if (this.matchKeyword("class")) {
                                        ...
                                        if (this.context.strict) {
                                            ...
                                            this.tolerateUnexpectedToken(h, n.Messages.GeneratorInLegacyContext);
                                        }
                                        o = c;
                                    } else {
                            ...
                            Parser.prototype.parseFunctionDeclaration = function(e) {
                                ...
                                if (!e || !this.match("(")) {
                                    ...
                                    if (this.context.strict) {
                                        if (this.scanner.isRestrictedWord(h.value)) {
                                            this.tolerateUnexpectedToken(h, n.Messages.StrictFunctionName);
                                        }
                                    } else {
                                        if (this.scanner.isRestrictedWord(h.value)) {
                                            u = h;
                                ...
                                return i ? this.finalize(t, new a.AsyncFunctionDeclaration(o, f, D)) : this.finalize(t, new a.FunctionDeclaration(o, f, D, r));
                            };
                            Parser.prototype.parseFunctionExpression = function() {
                                ...
                                return t ? this.finalize(e, new a.AsyncFunctionExpression(s, p, x)) : this.finalize(e, new a.FunctionExpression(s, p, x, i));
                            };
                            Parser.prototype.parseDirective = function() {
                                var e = this.lookahead;
                                var t = this.createNode();
                                var i = this.parseExpression();
                                var r = i.type === u.Syntax.Literal ? this.getTokenRaw(e).slice(1, -1) : null;
                                this.consumeSemicolon();
                                return this.finalize(t, r ? new a.Directive(i, r) : new a.ExpressionStatement(i));
                            };
                                ...
                                while(true){
                                    ...
                                    if (s === "use strict") {
                                        ...
                                        if (!this.context.allowStrictDirective) {
                                            this.tolerateUnexpectedToken(i, n.Messages.IllegalLanguageModeDirective);
                                        }
                                    } else {
                                        if (!e && i.octal) {
                                            e = i;
                            ...
                            Parser.prototype.parseGetterMethod = function() {
                                ...
                                var s = this.parsePropertyMethod(r);
                                this.context.allowYield = i;
                                return this.finalize(e, new a.FunctionExpression(null, r.params, s, t));
                            };
                            ...
                            Parser.prototype.parseImportDeclaration = function() {
                                ...
                                if (this.lookahead.type === 8) {
                                    ...
                                    if (!this.matchContextualKeyword("from")) {
                                        var r = this.lookahead.value ? n.Messages.UnexpectedToken : n.Messages.MissingFromClause;
                            ...
                            Parser.prototype.parseExportDeclaration = function() {
                                ...
                                if (this.matchKeyword("default")) {
                                    ...
                                    t = this.finalize(e, new a.ExportNamedDeclaration(i, [], null));
                                            ...
                                            switch(u){
                                                ...
                                                default:
                                                    if (u === "0") {
                                                        ...
                                                        e += "\0";
                                                    } else if (s.Character.isOctalDigit(u.charCodeAt(0))) {
                                                        this.throwUnexpectedToken(n.Messages.TemplateOctalLiteral);
                                                    } else {
                                                        e += u;
                                                    }
...
//# sourceMappingURL=node_modules_next_dist_compiled_comment-json_index_9a9a1785.js.map