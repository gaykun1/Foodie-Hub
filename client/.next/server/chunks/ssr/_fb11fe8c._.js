...
const page = ()=>{
    ...
    const onSubmit = async (data)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:5200/api/restaurants/create-place", {});
        } catch (err) {
            console.log(err);
        }
    };
...
//# sourceMappingURL=_fb11fe8c._.js.map