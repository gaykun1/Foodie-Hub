...
"[project]/node_modules/next/dist/server/base-server.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
const _decodepathparams = __turbopack_context__.r("[project]/node_modules/next/dist/server/lib/router-utils/decode-path-params.js [app-rsc] (ecmascript)");
...
const _utils4 = __turbopack_context__.r("[project]/node_modules/next/dist/server/instrumentation/utils.js [app-rsc] (ecmascript)");
...
const _utils5 = __turbopack_context__.r("[project]/node_modules/next/dist/server/response-cache/utils.js [app-rsc] (ecmascript)");
...
class Server {
   ...
   */ constructor(options){
        ...
        this.handleNextDataRequest = async (req, res, parsedUrl)=>{
            ...
            if (params.path[0] !== this.buildId) {
                ...
                if (("TURBOPACK compile-time value", "nodejs") !== 'edge' && (0, _requestmeta.getRequestMeta)(req, 'middlewareInvoke')) {
                    return false;
                }
   ...
   */ this.normalize = (pathname)=>{
        ...
        this.dir = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_context__.r("[externals]/path [external] (path, cjs)").resolve(dir);
        this.quiet = quiet;
        this.loadEnvConfig({
            dev
        });
        ...
        this.port = port;
        this.distDir = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : __turbopack_context__.r("[externals]/path [external] (path, cjs)").join(this.dir, this.nextConfig.distDir);
    ...
    async handleRequestImpl(req, res, parsedUrl) {
        try {
            ...
            const useInvokePath = !useMatchedPathHeader && ("TURBOPACK compile-time value", "nodejs") !== 'edge' && invokePath;
            if (useInvokePath) {
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = this.isAppPPREnabled && typeof routeModule !== 'undefined' && (0, _checks.isAppPageRouteModule)(routeModule);
        ...
        if (hasServerProps || isSSG || isAppPath) {
            ...
            if ("TURBOPACK compile-time truthy", 1) {
                const { tryGetPreviewData } = __turbopack_context__.r("[project]/node_modules/next/dist/server/api-utils/node/try-get-preview-data.js [app-rsc] (ecmascript)");
        ...
        const doRender = async ({ postponed, pagesFallback = false, fallbackRouteParams })=>{
            ...
            if (routeModule) {
                if ((0, _checks.isAppRouteRouteModule)(routeModule)) {
                    ...
                    ("TURBOPACK compile-time value", "nodejs") === 'edge' || !(0, _helpers.isNodeNextRequest)(req) || !(0, _helpers.isNodeNextResponse)(res)) {
        ...
        let responseGenerator = async ({ hasResolved, previousCacheEntry, isRevalidating })=>{
            ...
            //
            if (("TURBOPACK compile-time value", "nodejs") !== 'edge' && !this.minimalMode && fallbackMode !== _fallback.FallbackMode.BLOCKING_STATIC_RENDER && staticPathKey && !didRespond && !isPreviewMode && isDynamic && (isProduction || !staticPaths || !isPageIncludedInStaticPaths)) {
                if (// getStaticPaths.
                ...
                if ((0, _checks.isPagesRouteModule)(components.routeModule) && !isNextDataRequest) {
                    ...
                    fallbackResponse = await this.responseCache.get(isProduction ? locale ? `/${locale}${pathname}` : pathname : null, async ({ previousCacheEntry: previousFallbackCacheEntry = null })=>{
                    ...
                    // We use the response cache here to handle the revalidation and
                    // management of the fallback shell.
                    fallbackResponse = await this.responseCache.get(isProduction ? pathname : null, async ()=>doRender({
    ...
    async renderToResponseImpl(ctx) {
        ...
        try {
            ...
            if (!isWrappedError) {
                if (this.minimalMode && ("TURBOPACK compile-time value", "nodejs") !== 'edge' || this.renderOpts.dev) {
...
//# sourceMappingURL=node_modules_next_dist_server_base-server_82a3f157.js.map