...
"[project]/node_modules/next/dist/compiled/postcss-modules-local-by-default/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
    ...
    var e = {
                ...
                while(l < f){
                    ...
                    if (d < 32 || d > 126) {
                        ...
                        if (t.escapeEverything) {
                            ...
                            h = "\\" + d.toString(16).toUpperCase() + " ";
                        } else if (p == "\\" || !o && (p == '"' && r == p || p == "'" && r == p) || o && s.test(p)) {
                            h = "\\" + p;
                        } else {
                            h = p;
                        }
        ...
        742: (e, t, r)=>{
                        ...
                        case "root":
                            {
                                ...
                                s = t.nodes.map((r)=>{
                                    ...
                                    if (typeof e === "undefined") {
                                        ...
                                        throw new Error('Inconsistent rule global/local result in rule "' + t + '" (multiple selectors must result in the same mode for the rule)');
                                    }
                                    if (!n.hasLocals) {
                        ...
                        case "pseudo":
                            {
                                ...
                                if (a) {
                                    ...
                                    if (o) {
                                        ...
                                        if (i.inside) {
                                            throw new Error(`A ${t.value} is not allowed inside of a ${i.inside}(...)`);
                                        }
                                        e = {
                                        ...
                                        s = t.map((t)=>transform(t, e)).reduce((e, t)=>e.concat(t.nodes), []);
                                        if (s.length) {
                                            ...
                                            n.spaces = {
                                                before: e,
                                                after: n.spaces.after
                                            };
                                            i.spaces = {
                                                before: i.spaces.before,
                                                after: r
                                            };
                                        }
                                        t = s;
            ...
            function localizeDeclNode(e, t) {
                switch(e.type){
                    case "word":
                        ...
                        break;
                    case "function":
                        if (t.options && t.options.rewriteUrl && e.value.toLowerCase() === "url") {
                            e.nodes.map((e)=>{
            ...
            function localizeDeclarationValues(e, t, r) {
                const n = i(t.value);
                n.walk((t, n, i)=>{
                    if (t.type === "function" && (t.value.toLowerCase() === "var" || t.value.toLowerCase() === "env")) {
                        return false;
                    }
                ...
                if (r) {
                    ...
                    const n = i(e.value).walk((e)=>{
                        if (e.type === "div") {
                            r = {};
                            return;
                        } else if (e.type === "function" && e.value.toLowerCase() === "local" && e.nodes.length === 1) {
                            e.type = "word";
            ...
            const isNodeWithoutDeclarations = (e)=>{
                if (e.nodes.length > 0) {
                    return !e.nodes.every((e)=>e.type === "rule" || e.type === "atrule" && !isNodeWithoutDeclarations(e));
                }
                return true;
            };
            e.exports = (e = {})=>{
                if (e && e.mode && e.mode !== "global" && e.mode !== "local" && e.mode !== "pure") {
                    ...
                    prepare () {
                        ...
                        return {
                            Once (i) {
                                    ...
                                    if (/keyframes$/i.test(i.name)) {
                                        ...
                                        if (t) {
                                            if (a) {
                                                ...
                                                if (!e) {
                                                    throw i.error("@keyframes :global(...) is not allowed in pure mode");
                                                } else {
                                                    e.remove();
                                                }
                                            }
                                        ...
                                        if (i.params) {
                                            ...
                                            i.params = i.params.split("to").map((t)=>{
                                                const s = t.trim().slice(1, -1).trim();
                                                const o = localizeNode(s, e.mode, n);
                                                o.options = e;
                                                o.localAliasMap = n;
                                                if (a && o.hasPureGlobals && !r) {
                                                    throw i.error('Selector in at-rule"' + s + '" is not pure ' + "(pure selectors must contain at least one local class or id)");
                                                }
                                                return `(${o.selector})`;
                                            }).join(" to ");
                                        }
                                ...
                                i.walkRules((r)=>{
                                    if (r.parent && r.parent.type === "atrule" && /keyframes$/i.test(r.parent.name)) {
                                        return;
                                    }
                                    ...
                                    if (o && isNodeWithoutDeclarations(r) && !s) {
                                        throw r.error('Selector "' + r.selector + '" is not pure ' + "(pure selectors must contain at least one local class or id)");
                                    } else if (s) {
                                        s.remove();
                                    }
                                    if (t) {
        ...
        553: (e, t, r)=>{
            ...
            var O = (S = {}, S[y.space] = true, S[y.cr] = true, S[y.feed] = true, S[y.newline] = true, S[y.tab] = true, S);
            var w = Object.assign({}, O, (m = {}, m[y.comment] = true, m));
            function tokenStart(e) {
                return {
                    line: e[_.FIELDS.START_LINE],
                    column: e[_.FIELDS.START_COL]
                };
            }
            function tokenEnd(e) {
                return {
                    line: e[_.FIELDS.END_LINE],
                    column: e[_.FIELDS.END_COL]
                };
            }
            ...
            function getTokenSource(e) {
                return getSource(e[_.FIELDS.START_LINE], e[_.FIELDS.START_COL], e[_.FIELDS.END_LINE], e[_.FIELDS.END_COL]);
            }
            function getTokenSourceSpan(e, t) {
                if (!e) {
                    return undefined;
                }
                return getSource(e[_.FIELDS.START_LINE], e[_.FIELDS.START_COL], t[_.FIELDS.END_LINE], t[_.FIELDS.END_COL]);
            }
            ...
            var P = function() {
                ...
                e.attribute = function attribute() {
                    ...
                    this.position++;
                    while(this.position < this.tokens.length && this.currToken[_.FIELDS.TYPE] !== y.closeSquare){
                        ...
                        switch(c[_.FIELDS.TYPE]){
                            case y.space:
                                ...
                                if (a) {
                                    ...
                                    var h = (0, b.getProp)(n, "raws", "spaces", a, "after") || null;
                                    if (h) {
                            ...
                            case y.combinator:
                                ...
                                break;
                            case y.word:
                                if (p && this.content(p) === "|" && e[i + 2] && e[i + 2][_.FIELDS.TYPE] !== y.equals && !n.operator && !n.namespace) {
                                    n.namespace = l;
                                    a = "namespace";
                                    ...
                                    a = "attribute";
                                } else if (!n.value && n.value !== "" || a === "value" && !(u || n.quoteMark)) {
                                    var m = (0, b.unesc)(l);
                            ...
                            case y.str:
                                ...
                                var T = (0, f.unescapeValue)(l), k = T.unescaped, E = T.quoteMark;
                                n.value = k;
                                n.quoteMark = E;
                                a = "value";
                                (0, b.ensureObject)(n, "raws");
                            ...
                            case y.comment:
                                if (a) {
                                    if (u || p && p[_.FIELDS.TYPE] === y.space || a === "insensitive") {
                                        var D = (0, b.getProp)(n, "spaces", a, "after") || "";
                                        var I = (0, b.getProp)(n, "raws", "spaces", a, "after") || D;
                ...
                e.parseWhitespaceEquivalentTokens = function parseWhitespaceEquivalentTokens(e) {
                    if (e < 0) {
                    ...
                    if (n) {
                        if (i) {
                            ...
                            r.push(new c["default"]({
                                value: "",
                                source: getSource(a[_.FIELDS.START_LINE], a[_.FIELDS.START_COL], u[_.FIELDS.END_LINE], u[_.FIELDS.END_COL]),
                ...
                e.convertWhitespaceNodesToSpace = function convertWhitespaceNodesToSpace(e, t) {
                    var r = this;
                    if (t === void 0) {
                        t = false;
                    }
                    ...
                    e.forEach(function(e) {
                        ...
                        i += s + e.value + r.lossySpace(e.rawSpaceAfter, t && o.length === 0);
                    });
                    if (i === n) {
                        i = undefined;
                    }
                ...
                e.isNamedCombinator = function isNamedCombinator(e) {
                    ...
                    return this.tokens[e + 0] && this.tokens[e + 0][_.FIELDS.TYPE] === y.slash && this.tokens[e + 1] && this.tokens[e + 1][_.FIELDS.TYPE] === y.word && this.tokens[e + 2] && this.tokens[e + 2][_.FIELDS.TYPE] === y.slash;
                };
                e.namedCombinator = function namedCombinator() {
                    if (this.isNamedCombinator()) {
                        ...
                        var n = new d["default"]({
                            value: "/" + t + "/",
                            source: getSource(this.currToken[_.FIELDS.START_LINE], this.currToken[_.FIELDS.START_COL], this.tokens[this.position + 2][_.FIELDS.END_LINE], this.tokens[this.position + 2][_.FIELDS.END_COL]),
                            sourceIndex: this.currToken[_.FIELDS.START_POS],
                            raws: r
                        });
                ...
                e.combinator = function combinator() {
                    ...
                    if (t < 0 || this.tokens[t][_.FIELDS.TYPE] === y.comma || this.tokens[t][_.FIELDS.TYPE] === y.closeParenthesis) {
                        var r = this.parseWhitespaceEquivalentTokens(t);
                        if (r.length > 0) {
                            var n = this.current.last;
                            if (n) {
                                var i = this.convertWhitespaceNodesToSpace(r), s = i.space, o = i.rawSpace;
                                if (o !== undefined) {
                                    n.rawSpaceAfter += o;
                                }
                                n.spaces.after += s;
                    ...
                    if (this.isNamedCombinator()) {
                        ...
                        this.position++;
                    } else if (O[this.currToken[_.FIELDS.TYPE]]) {} else if (!u) {
                        this.unexpected();
                    }
                    if (c) {
                        if (u) {
                            var l = this.convertWhitespaceNodesToSpace(u), f = l.space, p = l.rawSpace;
                            c.spaces.before = f;
                            c.rawSpaceBefore = p;
                        }
                    } else {
                        var h = this.convertWhitespaceNodesToSpace(u, true), v = h.space, g = h.rawSpace;
                        if (!g) {
                            g = v;
                        }
                        var b = {};
                ...
                e.unexpectedPipe = function unexpectedPipe() {
                    return this.error("Unexpected '|'.", this.currToken[_.FIELDS.START_POS]);
                };
                    ...
                    if (e && e.type === g.PSEUDO) {
                        ...
                        if (e) {
                            ...
                            this.newNode(new c["default"]({
                                value: o,
                                source: getSource(s[_.FIELDS.START_LINE], s[_.FIELDS.START_COL], a[_.FIELDS.END_LINE], a[_.FIELDS.END_COL]),
                ...
                e.pseudo = function pseudo() {
                    ...
                    if (this.currToken[_.FIELDS.TYPE] === y.word) {
                        this.splitWord(false, function(n, i) {
                            t += n;
                            e.newNode(new l["default"]({
                                value: t,
                                source: getTokenSourceSpan(r, e.currToken),
                                sourceIndex: r[_.FIELDS.START_POS]
                            }));
                            if (i > 1 && e.nextToken && e.nextToken[_.FIELDS.TYPE] === y.openParenthesis) {
                ...
                e.space = function space() {
                    var e = this.content();
                    if (this.position === 0 || this.prevToken[_.FIELDS.TYPE] === y.comma || this.prevToken[_.FIELDS.TYPE] === y.openParenthesis || this.current.nodes.every(function(e) {
                        return e.type === "comment";
                    })) {
                        this.spaces = this.optionalSpace(e);
                        this.position++;
                    } else if (this.position === this.tokens.length - 1 || this.nextToken[_.FIELDS.TYPE] === y.comma || this.nextToken[_.FIELDS.TYPE] === y.closeParenthesis) {
                ...
                e.expected = function expected(e, t, r) {
                    ...
                    return this.error("Expected " + i + " " + e + ', found "' + r + '" instead.', {
                        index: t
                    });
                };
            ...
            var i = function() {
                ...
                e._run = function _run(e, t) {
                    ...
                    return new Promise(function(n, i) {
                        try {
                            var s = r._root(e, t);
                            Promise.resolve(r.func(s)).then(function(n) {
                                var i = undefined;
        ...
        767: (e, t, r)=>{
            ...
            function _setPrototypeOf(e, t) {
                _setPrototypeOf = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function _setPrototypeOf(e, t) {
                    e.__proto__ = t;
                    return e;
                };
            ...
            var u = r(124);
            var c = /^('|")([^]*)\1$/;
            var l = u(function() {}, "Assigning an attribute a value containing characters that might need to be escaped is deprecated. " + "Call attribute.setValue() instead.");
            var f = u(function() {}, "Assigning attr.quoted is deprecated and has no effect. Assign to attr.quoteMark instead.");
            var p = u(function() {}, "Constructing an Attribute selector with a value without specifying quoteMark is deprecated. Note: The value should be unescaped now.");
            ...
            function handleDeprecatedContructorOpts(e) {
                ...
                p();
                var t = unescapeValue(e.value), r = t.quoteMark, n = t.unescaped;
                if (!e.raws) {
                    e.raws = {};
                }
            ...
            var d = function(e) {
                ...
                t.toString = function toString() {
                    ...
                    if (this.operator && (this.value || this.value === "")) {
                        ...
                        t.push(this._stringFor("insensitiveFlag", "insensitive", function(t, r) {
                            if (t.length > 0 && !e.quoted && r.before.length === 0 && !(e.spaces.value && e.spaces.value.after)) {
                                r.before = " ";
                            }
                ...
                _createClass(Attribute, [
                    ...
                    },
                    {
                        ...
                        set: function set(e) {
                            if (this._constructed) {
                                var t = unescapeValue(e), r = t.deprecatedUsage, n = t.unescaped, i = t.quoteMark;
                                if (r) {
                                    l();
                                }
        ...
        300: (e, t, r)=>{
            ...
            var s = function(e) {
                ...
                t.removeAll = function removeAll() {
                    for(var e = _createForOfIteratorHelperLoose(this.nodes), t; !(t = e()).done;){
                        var r = t.value;
                        r.parent = undefined;
                    }
                    this.nodes = [];
        ...
        93: (e, t, r)=>{
            ...
            var n = r(763);
            var i;
            var s = (i = {}, i[n.ATTRIBUTE] = true, i[n.CLASS] = true, i[n.COMBINATOR] = true, i[n.COMMENT] = true, i[n.ID] = true, i[n.NESTING] = true, i[n.PSEUDO] = true, i[n.ROOT] = true, i[n.SELECTOR] = true, i[n.STRING] = true, i[n.TAG] = true, i[n.UNIVERSAL] = true, i);
            function isNode(e) {
        ...
        616: (e, t, r)=>{
            ...
            var s = function() {
                ...
                e.appendToPropertyAndEscape = function appendToPropertyAndEscape(e, t, r) {
                    if (!this.raws) {
                        this.raws = {};
                    }
                    var n = this[e];
        ...
        763: (e, t)=>{
            "use strict";
            t.__esModule = true;
            t.UNIVERSAL = t.TAG = t.STRING = t.SELECTOR = t.ROOT = t.PSEUDO = t.NESTING = t.ID = t.COMMENT = t.COMBINATOR = t.CLASS = t.ATTRIBUTE = void 0;
            var r = "tag";
            t.TAG = r;
            var n = "string";
            t.STRING = n;
        ...
        530: (e, t)=>{
            "use strict";
            t.__esModule = true;
            t.word = t.tilde = t.tab = t.str = t.space = t.slash = t.singleQuote = t.semicolon = t.plus = t.pipe = t.openSquare = t.openParenthesis = t.newline = t.greaterThan = t.feed = t.equals = t.doubleQuote = t.dollar = t.cr = t.comment = t.comma = t.combinator = t.colon = t.closeSquare = t.closeParenthesis = t.caret = t.bang = t.backslash = t.at = t.asterisk = t.ampersand = void 0;
            var r = 38;
            t.ampersand = r;
            var n = 42;
            t.asterisk = n;
        ...
        999: (e, t, r)=>{
            ...
            var o = (i = {}, i[n.tab] = true, i[n.newline] = true, i[n.cr] = true, i[n.feed] = true, i);
            var a = (s = {}, s[n.space] = true, s[n.tab] = true, s[n.newline] = true, s[n.cr] = true, s[n.feed] = true, s[n.ampersand] = true, s[n.asterisk] = true, s[n.bang] = true, s[n.comma] = true, s[n.colon] = true, s[n.semicolon] = true, s[n.openParenthesis] = true, s[n.closeParenthesis] = true, s[n.openSquare] = true, s[n.closeSquare] = true, s[n.singleQuote] = true, s[n.doubleQuote] = true, s[n.plus] = true, s[n.pipe] = true, s[n.tilde] = true, s[n.greaterThan] = true, s[n.equals] = true, s[n.dollar] = true, s[n.caret] = true, s[n.slash] = true, s);
            var u = {};
                ...
                while(u < s){
                    ...
                    switch(l){
                        ...
                        case n.feed:
                            ...
                            }while (l === n.space || l === n.newline || l === n.tab || l === n.cr || l === n.feed)
                            O = n.space;
                            d = a;
                            p = g - o - 1;
                            c = g;
                        ...
                        case n.pipe:
                            ...
                            do {
                                g += 1;
                                l = r.charCodeAt(g);
                            }while (l === n.plus || l === n.greaterThan || l === n.tilde || l === n.pipe)
                            O = n.combinator;
                            d = a;
                            p = u - o;
                            c = g;
        ...
        903: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/icss-utils/index.js [app-rsc] (ecmascript)");
        },
        45: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/postcss-value-parser/index.js [app-rsc] (ecmascript)");
        },
        837: (e)=>{
            "use strict";
...
//# sourceMappingURL=node_modules_next_dist_compiled_postcss-modules-local-by-default_index_64666dbf.js.map