...
"[project]/node_modules/next/dist/compiled/amphtml-validator/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
    ...
    var e = {
        ...
        409: (e)=>{
            e["exports"] = function(e) {
                ...
                return function(t, n, o) {
                    return t === " " ? t : e[r[Math.round(Math.random() * (r.length - 2))]](t);
                };
            };
        },
        917: (e)=>{
        ...
        725: (e, r, t)=>{
            ...
            function supportsColor(e) {
                ...
                if ("TURBOPACK compile-time truthy", 1) {
                    ...
                    if (Number(process.versions.node.split(".")[0]) >= 8 && Number(t[0]) >= 10 && Number(t[2]) >= 10586) {
        ...
        52: (e, r, t)=>{
            ...
            function resolve(e, r) {
                if (r === e) {
                    return reject(e, new TypeError("A promise cannot be resolved with itself."));
                }
            ...
            function denodeifyWithoutCount(e) {
                ...
                var s = [
                    ...
                    t.concat([
                        ...
                        return "case " + r + ":" + "res = fn.call(" + [
                            "self"
                        ].concat(t.slice(0, r)).concat("cb").join(",") + ");" + "break;";
                    }).join(""),
                    "default:",
                    "args[argLength] = cb;",
        ...
        639: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[externals]/domain [external] (domain, cjs)");
        },
        147: (e)=>{
            "use strict";
        ...
        318: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/commander/index.js [app-rsc] (ecmascript)");
        },
        37: (e)=>{
            "use strict";
        ...
        144: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[externals]/vm [external] (vm, cjs)");
        }
    };
    var r = {};
    ...
    (()=>{
        ...
        function readFromUrl(e, r) {
            return new u(function(t, n) {
                ...
                const a = s.request(e, function(r) {
                    if (r.statusCode !== 200) {
                        r.resume();
                        n(new Error("Unable to fetch " + e + " - HTTP Status " + r.statusCode));
                    } else {
                        t(r);
                    }
                });
        ...
        function Validator(e) {
            ...
            try {
                ...
                throw new Error("Could not instantiate validator_wasm.js - " + e.message);
            }
        }
        ...
        function main() {
            ...
            getInstance(e.validator_js, e.userAgent).then(function(n) {
                u.all(t).then(function(r) {
                    const t = {};
                    let o = false;
                    for(let i = 0; i < r.length; i++){
                        ...
                        if (e.format === "json") {
                            ...
                            logValidationResult(a.args[i], s, e.format === "color" ? true : false);
                        }
                        if (s.status !== "PASS") {
                            o = true;
                        }
                    ...
                    process.stderr.write((e.format == "color" ? r.red(t.message) : t.message) + "\n", function() {
                        process.exit(1);
                    });
                });
            }).catch(function(t) {
...
//# sourceMappingURL=node_modules_next_dist_compiled_amphtml-validator_index_90026af5.js.map