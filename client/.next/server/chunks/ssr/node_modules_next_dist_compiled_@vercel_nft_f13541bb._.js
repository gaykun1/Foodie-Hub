...
"[project]/node_modules/next/dist/compiled/@vercel/nft/LICENSE [app-rsc] (ecmascript)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const e = new Error(`Could not parse module '[project]/node_modules/next/dist/compiled/@vercel/nft/LICENSE'

Expected ';', '}' or <eof>`);
e.code = 'MODULE_UNPARSEABLE';
throw e;}}),
"[project]/node_modules/next/dist/compiled/@vercel/nft/package.json (json)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v(JSON.parse("{\"name\":\"@vercel/nft\",\"main\":\"index.js\",\"license\":\"MIT\"}"));}}),
"[project]/node_modules/next/dist/compiled/@vercel/nft/index.js [app-rsc] (ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    var __webpack_modules__ = {
        1730: (e, t, r)=>{
            "use strict";
            e.exports = t;
            t.mockS3Http = r(4287).get_mockS3Http();
            t.mockS3Http("on");
                ...
                h.forEach((e)=>{
                    r.commands[e] = function(t, s) {
                        ...
                        return __turbopack_context__.f({
                            "./LICENSE": {
                                id: ()=>"[project]/node_modules/next/dist/compiled/@vercel/nft/LICENSE [app-rsc] (ecmascript)",
                                module: ()=>__turbopack_context__.r("[project]/node_modules/next/dist/compiled/@vercel/nft/LICENSE [app-rsc] (ecmascript)")
                            },
                            "./index": {
                                id: ()=>"[project]/node_modules/next/dist/compiled/@vercel/nft/index.js [app-rsc] (ecmascript)",
                                module: ()=>__turbopack_context__.r("[project]/node_modules/next/dist/compiled/@vercel/nft/index.js [app-rsc] (ecmascript)")
                            },
                            "./index.js": {
                                id: ()=>"[project]/node_modules/next/dist/compiled/@vercel/nft/index.js [app-rsc] (ecmascript)",
                                module: ()=>__turbopack_context__.r("[project]/node_modules/next/dist/compiled/@vercel/nft/index.js [app-rsc] (ecmascript)")
                            ...
                            "./package": {
                                id: ()=>"[project]/node_modules/next/dist/compiled/@vercel/nft/package.json (json)",
                                module: ()=>__turbopack_context__.r("[project]/node_modules/next/dist/compiled/@vercel/nft/package.json (json)")
                            },
                            "./package.json": {
                                id: ()=>"[project]/node_modules/next/dist/compiled/@vercel/nft/package.json (json)",
                                module: ()=>__turbopack_context__.r("[project]/node_modules/next/dist/compiled/@vercel/nft/package.json (json)")
            ...
            g.usage = function usage() {
                const e = [
                    ...
                    h.map((e)=>"    - " + e + " - " + __turbopack_context__.f({
                            "./LICENSE": {
                                id: ()=>"[project]/node_modules/next/dist/compiled/@vercel/nft/LICENSE [app-rsc] (ecmascript)",
                                module: ()=>__turbopack_context__.r("[project]/node_modules/next/dist/compiled/@vercel/nft/LICENSE [app-rsc] (ecmascript)")
                            },
        ...
        6375: (e, t, r)=>{
            ...
            const s = r(7147);
            e.exports = t;
            const a = process.version.substr(1).replace(/-.*$/, "").split(".").map((e)=>+e);
            const o = [
                "build",
                "clean",
                "configure",
            ...
            e.exports.validate_package_json = function(t, r) {
                ...
                if (c && !e.exports.get_best_napi_build_version(t, r) && e.exports.build_napi_only(t)) {
                    throw new Error("The Node-API version of this Node instance is " + e.exports.get_napi_version(r ? r.target : undefined) + ". " + "This module supports Node-API version(s) " + e.exports.get_napi_build_versions_raw(t) + ". " + "This Node instance cannot run this module.");
                }
            ...
            function pathOK(e) {
                return e && (e.indexOf("{napi_build_version}") !== -1 || e.indexOf("{node_napi_label}") !== -1);
            }
                ...
                if (t.binary && t.binary.napi_versions) {
                    t.binary.napi_versions.forEach((e)=>{
                        ...
                        if (!t && c && e <= c) {
                            ...
                            o.info("This Node instance does not support builds for Node-API version", e);
                        }
                    });
                }
            ...
            e.exports.build_napi_only = function(e) {
                return e.binary && e.binary.package_name && e.binary.package_name.indexOf("{node_napi_label}") === -1;
            };
        },
        4287: (e, t, r)=>{
            "use strict";
            ...
            e.exports.detect = function(e, t) {
                ...
                const a = s.parse(r);
                t.prefix = !a.pathname || a.pathname === "/" ? "" : a.pathname.replace("/", "");
            ...
            e.exports.get_mockS3Http = function() {
                ...
                const t = r(4997);
                const s = "https://mapbox-node-pre-gyp-public-testing-bucket.s3.us-east-1.amazonaws.com";
                const u = process.env.node_pre_gyp_mock_s3 + "/mapbox-node-pre-gyp-public-testing-bucket";
                const mock_http = ()=>{
                    function get(e, t) {
                    ...
                    return t(s).persist().get(()=>e).reply(get);
                };
                mock_http(t, s, u);
                const mockS3Http = (t)=>{
                    const r = e;
        ...
        106: (e, t, r)=>{
            ...
            function get_node_abi(e, t) {
                ...
                if (r.major === 0 && r.minor % 2) {
                    ...
                    return t.modules ? e + "-v" + +t.modules : "v8-" + t.v8.split(".").slice(0, 2).join(".");
                }
            }
                        ...
                        if (f[t]) {
                            ...
                            if (s === 1) {
                                while(true){
                                    ...
                                    if (f[e]) {
                                        r = f[e];
                                        console.log("Warning: node-pre-gyp could not find exact match for " + t);
                                        console.log("Warning: but node-pre-gyp successfully choose " + e + " as ABI compatible target");
                                        break;
                                    }
                                    if (a === 0 && o === 0) {
                                        break;
                                ...
                                if (d[s]) {
                                    r = f[d[s]];
                                    console.log("Warning: node-pre-gyp could not find exact match for " + t);
                                    console.log("Warning: but node-pre-gyp successfully choose " + d[s] + " as ABI compatible target");
                                }
                            } else if (s === 0) {
                                if (e[1] % 2 === 0) {
                                    while(--o > 0){
            ...
            function validate_config(e, t) {
                ...
                if (a) {
                    ...
                    if (e === "http:") {
                        throw new Error("'host' protocol (" + e + ") is invalid - only 'https:' is accepted");
                    }
                }
            ...
            e.exports.evaluate = function(e, t, r) {
                ...
                const g = {
                    ...
                    node_abi_napi: c.get_napi_version(t.target) ? "napi" : get_runtime_abi(p, t.target),
                ...
                const y = process.env["npm_config_" + D + "_binary_host_mirror"] || e.binary.host;
                ...
                g.remote_path = e.binary.remote_path ? drop_double_slashes(fix_slashes(eval_template(e.binary.remote_path, g))) : v;
        ...
        2669: function(e, t, r) {
            ...
            const E = s(r(1730));
            const w = r(7310);
            const x = f.Parser.extend(r(5478).gC);
            const C = s(r(2037));
            const F = r(6151);
            const S = s(r(2382));
            const A = {
            ...
            H.resolve = H.default.resolve = function(...e) {
                return a.default.resolve.apply(this, [
                    K,
                    ...e
                ]);
            };
            ...
            async function analyze(e, t, r) {
                ...
                const emitAssetDirectory = (e)=>{
                    ...
                    const f = e.slice(o);
                    const d = f.replace(c.wildcardRegEx, (e, t)=>f[t - 1] === a.default.sep ? "**/*" : "*").replace(Y, "/**/*") || "/**/*";
                    if (r.ignoreFn(a.default.relative(r.base, u + d))) return;
                    P = P.then(async ()=>{
                        if (r.log) console.log("Globbing " + u + d);
                        const e = await new Promise((e, t)=>(0, h.default)(u + d, {
                                mark: true,
                                ignore: u + "/**/node_modules/**/*",
                                dot: true
                            }, (r, s)=>r ? t(r) : e(s)));
                        e.filter((e)=>!$.has(a.default.extname(e)) && !G.has(a.default.basename(e)) && !e.endsWith("/")).forEach((e)=>s.add(e));
                    });
                };
                ...
                try {
                    ...
                    if (!s) {
                        r.warnings.add(new Error(`Failed to parse ${e} as script:\n${t && t.message}`));
                    }
                }
                if (!M) {
                    try {
                        ...
                        r.warnings.add(new Error(`Failed to parse ${e} as module:\n${t && t.message}`));
                        return {
                            assets: s,
                            deps: f,
                            imports: D,
                        ...
                        if (e.type === "ImportDeclaration") {
                            ...
                            if (r) {
                                for (const t of e.specifiers){
                                    if (t.type === "ImportNamespaceSpecifier") setKnownBinding(t.local.name, {
                                        value: r
                                    });
                                    else if (t.type === "ImportDefaultSpecifier" && "default" in r) setKnownBinding(t.local.name, {
                                        value: r.default
                                    });
                                    else if (t.type === "ImportSpecifier" && t.imported.name in r) setKnownBinding(t.local.name, {
                                        value: r[t.imported.name]
                                    });
                                }
                            }
                        } else if (e.type === "ExportNamedDeclaration" || e.type === "ExportAllDeclaration") {
                ...
                function emitWildcardRequire(e) {
                    if (!r.analysis.emitGlobs || !e.startsWith("./") && !e.startsWith("../")) return;
                    e = a.default.resolve(E, e);
                    const t = e.indexOf(c.WILDCARD);
                    const s = t === -1 ? e.length : e.lastIndexOf(a.default.sep, t);
                    const o = e.substring(0, s);
                    const u = e.slice(s);
                    let d = u.replace(c.wildcardRegEx, (e, t)=>u[t - 1] === a.default.sep ? "**/*" : "*") || "/**/*";
                    if (!d.endsWith("*")) d += "?(" + (r.ts ? ".ts|.tsx|" : "") + ".js|.json|.node)";
                    if (r.ignoreFn(a.default.relative(r.base, o + d))) return;
                    P = P.then(async ()=>{
                        if (r.log) console.log("Globbing " + o + d);
                        const e = await new Promise((e, t)=>(0, h.default)(o + d, {
                                mark: true,
                                ignore: o + "/**/node_modules/**/*"
                            }, (r, s)=>r ? t(r) : e(s)));
                        e.filter((e)=>!$.has(a.default.extname(e)) && !G.has(a.default.basename(e)) && !e.endsWith("/")).forEach((e)=>f.add(e));
                    });
                }
                async function processRequireArg(e, t = false) {
                    ...
                    if ("value" in r && typeof r.value === "string") {
                        ...
                        if ("then" in r && typeof r.then === "string") (t ? D : f).add(r.then);
                        if ("else" in r && typeof r.else === "string") (t ? D : f).add(r.else);
                    }
                }
                ...
                async function backtrack(e, t) {
                    if (!Z) throw new Error("Internal error: No staticChildNode for backtrack.");
                    const r = await computePureStaticValue(e, true);
                    if (r) {
                        if ("value" in r && typeof r.value !== "symbol" || "then" in r && typeof r.then !== "symbol" && typeof r.else !== "symbol") {
                            X = r;
                            Z = e;
                            if (t) t.skip();
                            return;
                ...
                await (0, o.asyncWalk)(M, {
                    async enter (t, o) {
                        ...
                        if (u.type === "Identifier") {
                            if ((0, p.isIdentifierRead)(u, c) && r.analysis.computeFileReferences) {
                                let e;
                                if (typeof (e = getKnownBinding(u.name)?.value) === "string" && e.match(z) || e && (typeof e === "function" || typeof e === "object") && e[q]) {
                                    X = {
                                        value: typeof e === "string" ? e : undefined
                                    };
                                    Z = u;
                                    await backtrack(c, this);
                                }
                            }
                        } else if (r.analysis.computeFileReferences && u.type === "MemberExpression" && u.object.type === "MetaProperty" && u.object.meta.name === "import" && u.object.property.name === "meta" && (u.property.computed ? u.property.value : u.property.name) === "url") {
                            X = {
                                value: Q
                            };
                            Z = u;
                            ...
                            if ((!H || r.mixedModules) && u.callee.type === "Identifier" && u.arguments.length) {
                                if (u.callee.name === "require" && J.require.shadowDepth === 0) {
                                    await processRequireArg(u.arguments[0]);
                                    return;
                                }
                            } else if ((!H || r.mixedModules) && u.callee.type === "MemberExpression" && u.callee.object.type === "Identifier" && u.callee.object.name === "module" && "module" in J === false && u.callee.property.type === "Identifier" && !u.callee.computed && u.callee.property.name === "require" && u.arguments.length) {
                                await processRequireArg(u.arguments[0]);
                                return;
                            } else if ((!H || r.mixedModules) && u.callee.type === "MemberExpression" && u.callee.object.type === "Identifier" && u.callee.object.name === "require" && J.require.shadowDepth === 0 && u.callee.property.type === "Identifier" && !u.callee.computed && u.callee.property.name === "resolve" && u.arguments.length) {
                                await processRequireArg(u.arguments[0]);
                                return;
                            }
                            const t = r.analysis.evaluatePureExpressions && await computePureStaticValue(u.callee, false);
                            if (t && "value" in t && typeof t.value === "function" && t.value[q] && r.analysis.computeFileReferences) {
                                ...
                                switch(t.value){
                                    case V:
                                        if (u.arguments.length === 1 && u.arguments[0].type === "Literal" && u.callee.type === "Identifier" && J.require.shadowDepth === 0) {
                                            await processRequireArg(u.arguments[0]);
                                        }
                                        break;
                                    case L:
                                        if (u.arguments.length) {
                                            const e = await computePureStaticValue(u.arguments[0], false);
                                            if (e && "value" in e && e.value) {
                                                let t;
                                                if (typeof e.value === "object") t = e.value;
                                                else if (typeof e.value === "string") t = {
                                                    bindings: e.value
                                                };
                                                if (!t.path) {
                                                    t.path = true;
                                    ...
                                    case I:
                                        if (u.arguments.length) {
                                            ...
                                            if (e && "value" in e && e.value) {
                                                ...
                                                let r;
                                                try {
                                                    const e = u?.callee?.arguments?.[0]?.value || "node-gyp-build";
                                                    const s = (0, S.default)(t, e);
                                                    r = (()=>{
                                                        const e = new Error("Cannot find module as expression is too dynamic");
                                                        e.code = 'MODULE_NOT_FOUND';
                                                        throw e;
                                    ...
                                    case O:
                                        if (u.arguments.length) {
                                            const e = await computePureStaticValue(u.arguments[0], false);
                                            if (e && "value" in e && (typeof e.value === "string" || typeof e.value === "undefined")) {
                                                const t = (0, g.nbind)(e.value);
                                                if (t && t.path) {
                                                    f.add(a.default.relative(E, t.path).replace(/\\/g, "/"));
                                                    return this.skip();
                                                }
                                            }
                                        }
                                        break;
                                    case k:
                                        if (u.arguments.length === 2 && u.arguments[0].type === "Literal" && u.arguments[0].value === "view engine" && !ee) {
                                    ...
                                    case B:
                                        if (u.arguments[0] && r.analysis.computeFileReferences) {
                                            ...
                                            if (X) {
                                                Z = u.arguments[0];
                                                if (t.value === B && u.arguments[0].type === "Identifier" && u.arguments[0].name === "__dirname") {
                                    ...
                                    case T:
                                        if (u.arguments[0]) {
                                            const e = await computePureStaticValue(u.arguments[0], false);
                                            if (e && "value" in e && e.value) emitAssetDirectory(e.value + "/intl");
                                            return this.skip();
                                        }
                                        break;
                                    case j:
                                        let o = a.default.resolve(e, "../package.json");
                                        const p = a.default.resolve("/package.json");
                                        while(o !== p && await r.stat(o) === null)o = a.default.resolve(o, "../../package.json");
                                        if (o !== p) s.add(o);
                                        break;
                                }
                            }
                        } else if (u.type === "VariableDeclaration" && c && !(0, p.isVarLoop)(c) && r.analysis.evaluatePureExpressions) {
                                ...
                                if (t) {
                                    if (e.id.type === "Identifier") {
                                        ...
                                        for (const r of e.id.properties){
                                            if (r.type !== "Property" || r.key.type !== "Identifier" || r.value.type !== "Identifier" || typeof t.value !== "object" || t.value === null || !(r.key.name in t.value)) continue;
                                            setKnownBinding(r.value.name, {
                                                value: t.value[r.key.name]
                                            });
                                        }
                                    }
                                    if (!("value" in t) && isAbsolutePathOrUrl(t.then) && isAbsolutePathOrUrl(t.else)) {
                                        X = t;
                                        Z = e.init;
                                        await emitStaticChildAsset();
                                    }
                        ...
                        } else if (u.type === "AssignmentExpression" && c && !(0, p.isLoop)(c) && r.analysis.evaluatePureExpressions) {
                                ...
                                if (e && "value" in e) {
                                    if (u.left.type === "Identifier") {
                                        ...
                                        for (const t of u.left.properties){
                                            if (t.type !== "Property" || t.key.type !== "Identifier" || t.value.type !== "Identifier" || typeof e.value !== "object" || e.value === null || !(t.key.name in e.value)) continue;
                        ...
                        } else if ((!H || r.mixedModules) && (u.type === "FunctionDeclaration" || u.type === "FunctionExpression" || u.type === "ArrowFunctionExpression") && (u.arguments || u.params)[0] && (u.arguments || u.params)[0].type === "Identifier") {
                            let e;
                            let t;
                            if ((u.type === "ArrowFunctionExpression" || u.type === "FunctionExpression") && c && c.type === "VariableDeclarator" && c.id.type === "Identifier") {
                                e = c.id;
                            ...
                            if (e && u.body.body) {
                                ...
                                for(let e = 0; e < u.body.body.length; e++){
                                    if (u.body.body[e].type === "VariableDeclaration" && !r) {
                                        r = u.body.body[e].declarations.find((e)=>e && e.id && e.id.type === "Identifier" && e.init && e.init.type === "CallExpression" && e.init.callee.type === "Identifier" && e.init.callee.name === "require" && J.require.shadowDepth === 0 && e.init.arguments[0] && e.init.arguments[0].type === "Identifier" && e.init.arguments[0].name === t[0].name);
                                    }
                                    if (r && u.body.body[e].type === "ReturnStatement" && u.body.body[e].argument && u.body.body[e].argument.type === "Identifier" && u.body.body[e].argument.name === r.id.name) {
                                        s = true;
                                        break;
                                    }
                                }
                                if (s) setKnownBinding(e.name, {
                                    value: V
                                });
                            }
                        }
                ...
                function validWildcard(t) {
                    ...
                    else if (t.endsWith(a.default.sep + c.WILDCARD)) s = a.default.sep + c.WILDCARD;
                    ...
                    if (E.startsWith(t.slice(0, t.length - s.length) + a.default.sep)) return false;
                    if (C) {
                        const s = e.substring(0, e.indexOf(a.default.sep + "node_modules")) + a.default.sep + "node_modules" + a.default.sep;
                        if (!t.startsWith(s)) {
                            if (r.log) console.log("Skipping asset emission of " + t.replace(c.wildcardRegEx, "*") + " for " + e + " as it is outside the package base " + C);
                            return false;
                        }
                    }
                    return true;
                ...
                function resolveAbsolutePathOrUrl(e) {
                    return e instanceof w.URL ? (0, w.fileURLToPath)(e) : e.startsWith("file:") ? (0, w.fileURLToPath)(new w.URL(e)) : a.default.resolve(e);
                }
                async function emitStaticChildAsset() {
                    ...
                    } else if ("then" in X && "else" in X && isAbsolutePathOrUrl(X.then) && isAbsolutePathOrUrl(X.else)) {
                        let e;
                        try {
                    ...
                    } else if (Z && Z.type === "ArrayExpression" && "value" in X && X.value instanceof Array) {
        ...
        1305: function(e, t, r) {
            ...
            var o = this && this.__importStar || function(e) {
                ...
                var t = {};
                if (e != null) {
                    for(var r in e)if (r !== "default" && Object.prototype.hasOwnProperty.call(e, r)) s(t, e, r);
                }
                a(t, e);
                return t;
            };
            ...
            class Job {
                constructor({ base: e = process.cwd(), processCwd: t, exports: r, conditions: s = r || [
                    "node"
                ], exportsOnly: a = false, paths: o = {}, ignore: u, log: f = false, mixedModules: h = false, ts: v = true, analysis: D = {}, cache: y, fileIOConcurrency: m = 1024 }){
                    ...
                    this.maybeEmitDep = async (e, t, r)=>{
                        ...
                        try {
                            ...
                            a = o;
                            try {
                                if (this.ts && e.endsWith(".js") && o instanceof d.NotFoundError) {
                        ...
                        if (a) {
                            this.warnings.add(new Error(`Failed to resolve dependency "${e}":\n${a?.message}`));
                            return;
                        }
                        if (Array.isArray(s)) {
                            for (const e of s){
                    ...
                    if (typeof u === "function") {
                        ...
                        const t = u.map((t)=>(0, c.relative)(e, (0, c.resolve)(e || process.cwd(), t)));
                        this.ignoreFn = (e)=>{
                            if (e.startsWith(".." + c.sep)) return true;
                ...
                async realpath(e, t, r = new Set) {
                    if (r.has(e)) throw new Error("Recursive symlink detected resolving " + e);
                    r.add(e);
                    ...
                    return (0, v.join)(await this.realpath((0, c.dirname)(e), t, r), (0, c.basename)(e));
                }
                ...
                async emitDependency(e, t) {
                    ...
                    await Promise.all([
                        ...[
                            ...
                            if (r === ".js" || r === ".mjs" || r === ".node" || r === "" || this.ts && (r === ".ts" || r === ".tsx") && t.startsWith(this.base) && t.slice(this.base.length).indexOf(c.sep + "node_modules" + c.sep) === -1) await this.emitDependency(t, e);
                            else await this.emitFile(t, "asset", e);
                        }),
                        ...[
                            ...o
                        ].map(async (t)=>this.maybeEmitDep(t, e, !p)),
                        ...[
                            ...u
                        ].map(async (t)=>this.maybeEmitDep(t, e, false))
                    ]);
                }
            }
            t.Job = Job;
        ...
        7493: (e, t, r)=>{
            ...
            async function resolveDependency(e, t, r, a = true) {
                let o;
                if ((0, s.isAbsolute)(e) || e === "." || e === ".." || e.startsWith("./") || e.startsWith("../")) {
                    const a = e.endsWith("/");
                    o = await resolvePath((0, s.resolve)(t, "..", e) + (a ? "/" : ""), t, r);
                } else if (e[0] === "#") {
            ...
            async function resolveFile(e, t, r) {
                ...
                if (r.ts && e.startsWith(r.base) && e.slice(r.base.length).indexOf(s.sep + "node_modules" + s.sep) === -1 && await r.isFile(e + ".ts")) return e + ".ts";
                if (r.ts && e.startsWith(r.base) && e.slice(r.base.length).indexOf(s.sep + "node_modules" + s.sep) === -1 && await r.isFile(e + ".tsx")) return e + ".tsx";
            ...
            async function resolveDir(e, t, r) {
                ...
                if (a && typeof a.main === "string") {
                    const o = await resolveFile((0, s.resolve)(e, a.main), t, r) || await resolveFile((0, s.resolve)(e, a.main, "index"), t, r);
                    if (o) {
            ...
            function getPkgName(e) {
                const t = e.split("/");
                if (e[0] === "@" && t.length > 1) return t.length > 1 ? t.slice(0, 2).join("/") : null;
            ...
            function getExportsTarget(e, t, r) {
                if (typeof e === "string") {
                    ...
                    for (const s of e){
                        ...
                        if (e === null || typeof e === "string" && e.startsWith("./")) return e;
                    }
                } else if (typeof e === "object") {
                    for (const s of Object.keys(e)){
                        if (s === "default" || s === "require" && r || s === "import" && !r || t.includes(s)) {
            ...
            function resolveExportsImports(e, t, r, s, a, o) {
                let u;
                if (a) {
                    if (!(typeof t === "object" && !Array.isArray(t) && t !== null)) return undefined;
                    u = t;
                } else if (typeof t === "string" || Array.isArray(t) || t === null || typeof t === "object" && Object.keys(t).length && Object.keys(t)[0][0] !== ".") {
                    u = {
                        ".": t
                    };
                } else {
                ...
                for (const t of Object.keys(u).sort((e, t)=>t.length - e.length)){
                    if (t.endsWith("*") && r.startsWith(t.slice(0, -1))) {
                        ...
                        if (typeof a === "string" && a.startsWith("./")) return e + a.slice(1).replace(/\*/g, r.slice(t.length - 1));
                    }
                    if (!t.endsWith("/")) continue;
                    if (r.startsWith(t)) {
                        const a = getExportsTarget(u[t], s.conditions, o);
                        if (typeof a === "string" && a.endsWith("/") && a.startsWith("./")) return e + a.slice(1) + r.slice(t.length);
                    }
                }
                return undefined;
            }
                ...
                if (e !== "#" && !e.startsWith("#/") && r.conditions) {
                    ...
                    if (o) {
                        ...
                        if (u && c !== null && c !== undefined) {
                            ...
                            if (u) {
                                if (a) u = await resolveFile(u, t, r) || await resolveDir(u, t, r);
            ...
            async function resolvePackage(e, t, r, a) {
                ...
                if (r.conditions) {
                    ...
                    if (o) {
                        ...
                        if (u && u.name && u.name === c && d !== null && d !== undefined) {
                            f = resolveExportsImports(o, d, "." + e.slice(c.length), r, false, a);
                            if (f) {
                                if (a) f = await resolveFile(f, t, r) || await resolveDir(f, t, r);
                ...
                while((d = u.lastIndexOf(s.sep)) > p){
                    ...
                    if (r.conditions && v !== undefined && v !== null && !f) {
                        let u;
                        if (!r.exportsOnly) u = await resolveFile(o + s.sep + e, t, r) || await resolveDir(o + s.sep + e, t, r);
                        let f = resolveExportsImports(o + s.sep + c, v, "." + e.slice(c.length), r, false, a);
                        if (f) {
                            if (a) f = await resolveFile(f, t, r) || await resolveDir(f, t, r);
                            else if (!await r.isFile(f)) throw new NotFoundError(f, t);
                        }
                        if (f) {
                            await r.emitFile(o + s.sep + c + s.sep + "package.json", "resolve", t);
                            if (u && u !== f) return [
                                f,
                                u
                            ];
                        ...
                        const a = await resolveFile(o + s.sep + e, t, r) || await resolveDir(o + s.sep + e, t, r);
                        if (a) {
                            if (f && f !== a) return [
                                a,
                                f
                ...
                for (const s of Object.keys(r.paths)){
                    if (s.endsWith("/") && e.startsWith(s)) {
                        ...
                        const o = await resolveFile(a, t, r) || await resolveDir(a, t, r);
                        if (!o) {
                            throw new NotFoundError(e, t);
                        }
                        return o;
        ...
        4857: (e, t)=>{
            ...
            function isVarLoop(e) {
                return e.type === "ForStatement" || e.type === "ForInStatement" || e.type === "ForOfStatement";
            }
            t.isVarLoop = isVarLoop;
            function isLoop(e) {
                return e.type === "ForStatement" || e.type === "ForInStatement" || e.type === "ForOfStatement" || e.type === "WhileStatement" || e.type === "DoWhileStatement";
            }
            t.isLoop = isLoop;
        },
        5497: function(__unused_webpack_module, exports, __nccwpck_require__) {
            "use strict";
            ...
            const versioning = __nccwpck_require__(106);
            const napi = __nccwpck_require__(6375);
        ...
        9835: (e, t)=>{
            ...
            function getPackageBase(e) {
                ...
                if (t !== -1 && (e[t - 1] === "/" || e[t - 1] === "\\") && (e[t + 12] === "/" || e[t + 12] === "\\")) {
        ...
        7151: function(e, t, r) {
            ...
            async function sharedLibEmit(e, t) {
                ...
                if (!r) return;
                const s = await new Promise((e, t)=>(0, o.default)(r + c, {
        ...
        1488: function(e, t, r) {
            ...
            const f = {
                ...
                "@serialport/bindings-cpp" ({ id: e, emitAssetDirectory: t }) {
                    if (e.endsWith("@serialport/bindings-cpp/dist/index.js")) {
                ...
                "google-gax" ({ id: e, ast: t, emitAssetDirectory: r }) {
                    if (e.endsWith("google-gax/build/src/grpc.js")) {
                        for (const s of t.body){
                            if (s.type === "VariableDeclaration" && s.declarations[0].id.type === "Identifier" && s.declarations[0].id.name === "googleProtoFilesDir") {
                                r((0, a.resolve)((0, a.dirname)(e), "../../../google-proto-files"));
                            }
                        }
                    }
                },
                    ...
                    if (e.endsWith("oracledb/lib/oracledb.js")) {
                        for (const s of t.body){
                            if (s.type === "ForStatement" && "body" in s.body && s.body.body && Array.isArray(s.body.body) && s.body.body[0] && s.body.body[0].type === "TryStatement" && s.body.body[0].block.body[0] && s.body.body[0].block.body[0].type === "ExpressionStatement" && s.body.body[0].block.body[0].expression.type === "AssignmentExpression" && s.body.body[0].block.body[0].expression.operator === "=" && s.body.body[0].block.body[0].expression.left.type === "Identifier" && s.body.body[0].block.body[0].expression.left.name === "oracledbCLib" && s.body.body[0].block.body[0].expression.right.type === "CallExpression" && s.body.body[0].block.body[0].expression.right.callee.type === "Identifier" && s.body.body[0].block.body[0].expression.right.callee.name === "require" && s.body.body[0].block.body[0].expression.right.arguments.length === 1 && s.body.body[0].block.body[0].expression.right.arguments[0].type === "MemberExpression" && s.body.body[0].block.body[0].expression.right.arguments[0].computed === true && s.body.body[0].block.body[0].expression.right.arguments[0].object.type === "Identifier" && s.body.body[0].block.body[0].expression.right.arguments[0].object.name === "binaryLocations" && s.body.body[0].block.body[0].expression.right.arguments[0].property.type === "Identifier" && s.body.body[0].block.body[0].expression.right.arguments[0].property.name === "i") {
                                ...
                                const t = global._unit ? "3.0.0" : JSON.parse((0, c.readFileSync)(e.slice(0, -15) + "package.json", "utf8")).version;
                                const o = Number(t.slice(0, t.indexOf("."))) >= 4;
                                const u = "oracledb-" + (o ? t : "abi" + process.versions.modules) + "-" + process.platform + "-" + process.arch + ".node";
                    ...
                    if (e.endsWith("sharp/lib/index.js")) {
                        ...
                        for (const s of Object.keys(o.optionalDependencies || {})){
                            ...
                            try {
                                ...
                                if (e && e.code !== "ENOENT") {
                                    console.error(`Error reading "sharp" dependencies from "${o}/package.json"'`);
                                    throw e;
                                }
                            }
                        }
            ...
            async function handleSpecialCases({ id: e, ast: t, emitDependency: r, emitAsset: s, emitAssetDirectory: a, job: o }) {
        ...
        9437: (e, t, r)=>{
            ...
            t.wildcardRegEx = t.WILDCARD = t.FUNCTION = t.UNKNOWN = t.evaluate = void 0;
            const s = r(7310);
            ...
            const a = {
                ...
                ArrowFunctionExpression: async function(e, r) {
                    if (e.params.length === 0 && !e.generator && !e.async && e.expression) {
                ...
                BinaryExpression: async function BinaryExpression(e, r) {
                    ...
                    if (!a && !o) return;
                    if (!a) {
                        if (this.computeBranches && o && "value" in o && typeof o.value === "string") return {
                    ...
                    if (!o) {
                        if (this.computeBranches && s === "+") {
                            if (a && "value" in a && typeof a.value === "string") return {
                ...
                CallExpression: async function CallExpression(e, r) {
                    ...
                    for(let s = 0, a = e.arguments.length; s < a; s++){
                        ...
                        if (a) {
                            d = false;
                            if ("value" in a && typeof a.value === "string" && a.wildcards) a.wildcards.forEach((e)=>p.push(e));
                        } else {
                    ...
                    try {
                        ...
                        if (!u) {
                            if (p.length) {
                                if (typeof e !== "string" || countWildcards(e) !== p.length) return;
                                return {
                                    value: e,
                                    wildcards: p
                                };
                ...
                ConditionalExpression: async function ConditionalExpression(e, t) {
                    ...
                    if (r && "value" in r) return r.value ? t(e.consequent) : t(e.alternate);
                    if (!this.computeBranches) return;
                ...
                Identifier: async function Identifier(e, t) {
                    if (Object.hasOwnProperty.call(this.vars, e.name)) return this.vars[e.name];
                    return undefined;
                },
                ...
                MetaProperty: async function MetaProperty(e) {
                    if (e.meta.name === "import" && e.property.name === "meta") return {
                        value: this.vars["import.meta"]
                    };
                    return undefined;
                },
                    ...
                    if (r && "value" in r && r.value === s.URL && e.arguments.length) {
                        ...
                        if ("value" in r) {
                            if (a) {
                                try {
                                    return {
                                        value: new s.URL(r.value, a.value)
                                    };
                                } catch  {
                                    return undefined;
                                }
                ...
                ObjectExpression: async function ObjectExpression(e, r) {
                    ...
                    for(let a = 0; a < e.properties.length; a++){
                        ...
                        const u = o.computed ? r(o.key) : o.key && {
                            value: o.key.name || o.key.value
                        };
                ...
                SequenceExpression: async function SequenceExpression(e, t) {
                    if ("expressions" in e && e.expressions.length === 2 && e.expressions[0].type === "Literal" && e.expressions[0].value === 0 && e.expressions[1].type === "MemberExpression") {
        ...
        6151: (e, t, r)=>{
            ...
            function isUndefinedOrVoid(e) {
                return e.type === "Identifier" && e.name === "undefined" || e.type === "UnaryExpression" && e.operator === "void" && e.argument.type === "Literal" && e.argument.value === 0;
            }
            function handleWrappers(e) {
                let t;
                if (e.body.length === 1 && e.body[0].type === "ExpressionStatement" && e.body[0].expression.type === "UnaryExpression" && e.body[0].expression.operator === "!" && e.body[0].expression.argument.type === "CallExpression" && e.body[0].expression.argument.callee.type === "FunctionExpression" && e.body[0].expression.argument.arguments.length === 1) t = e.body[0].expression.argument;
                else if (e.body.length === 1 && e.body[0].type === "ExpressionStatement" && e.body[0].expression.type === "CallExpression" && e.body[0].expression.callee.type === "FunctionExpression" && (e.body[0].expression.arguments.length === 1 || e.body[0].expression.arguments.length === 0)) t = e.body[0].expression;
                else if (e.body.length === 1 && e.body[0].type === "ExpressionStatement" && e.body[0].expression.type === "AssignmentExpression" && e.body[0].expression.left.type === "MemberExpression" && e.body[0].expression.left.object.type === "Identifier" && e.body[0].expression.left.object.name === "module" && e.body[0].expression.left.property.type === "Identifier" && e.body[0].expression.left.property.name === "exports" && e.body[0].expression.right.type === "CallExpression" && e.body[0].expression.right.callee.type === "FunctionExpression" && e.body[0].expression.right.arguments.length === 1) t = e.body[0].expression.right;
                if (t) {
                    let e;
                    let r;
                    if (t.arguments[0] && t.arguments[0].type === "ConditionalExpression" && t.arguments[0].test.type === "LogicalExpression" && t.arguments[0].test.operator === "&&" && t.arguments[0].test.left.type === "BinaryExpression" && t.arguments[0].test.left.operator === "===" && t.arguments[0].test.left.left.type === "UnaryExpression" && t.arguments[0].test.left.left.operator === "typeof" && "name" in t.arguments[0].test.left.left.argument && t.arguments[0].test.left.left.argument.name === "define" && t.arguments[0].test.left.right.type === "Literal" && t.arguments[0].test.left.right.value === "function" && t.arguments[0].test.right.type === "MemberExpression" && t.arguments[0].test.right.object.type === "Identifier" && t.arguments[0].test.right.property.type === "Identifier" && t.arguments[0].test.right.property.name === "amd" && t.arguments[0].test.right.computed === false && t.arguments[0].alternate.type === "FunctionExpression" && t.arguments[0].alternate.params.length === 1 && t.arguments[0].alternate.params[0].type === "Identifier" && t.arguments[0].alternate.body.body.length === 1 && t.arguments[0].alternate.body.body[0].type === "ExpressionStatement" && t.arguments[0].alternate.body.body[0].expression.type === "AssignmentExpression" && t.arguments[0].alternate.body.body[0].expression.left.type === "MemberExpression" && t.arguments[0].alternate.body.body[0].expression.left.object.type === "Identifier" && t.arguments[0].alternate.body.body[0].expression.left.object.name === "module" && t.arguments[0].alternate.body.body[0].expression.left.property.type === "Identifier" && t.arguments[0].alternate.body.body[0].expression.left.property.name === "exports" && t.arguments[0].alternate.body.body[0].expression.left.computed === false && t.arguments[0].alternate.body.body[0].expression.right.type === "CallExpression" && t.arguments[0].alternate.body.body[0].expression.right.callee.type === "Identifier" && t.arguments[0].alternate.body.body[0].expression.right.callee.name === t.arguments[0].alternate.params[0].name && "body" in t.callee && "body" in t.callee.body && Array.isArray(t.callee.body.body) && t.arguments[0].alternate.body.body[0].expression.right.arguments.length === 1 && t.arguments[0].alternate.body.body[0].expression.right.arguments[0].type === "Identifier" && t.arguments[0].alternate.body.body[0].expression.right.arguments[0].name === "require") {
                        ...
                        if (e[0].type === "ExpressionStatement" && e[0].expression.type === "Literal" && e[0].expression.value === "use strict") {
                            e = e.slice(1);
                        }
                        if (e.length === 1 && e[0].type === "ExpressionStatement" && e[0].expression.type === "CallExpression" && e[0].expression.callee.type === "Identifier" && e[0].expression.callee.name === t.arguments[0].test.right.object.name && e[0].expression.arguments.length === 1 && e[0].expression.arguments[0].type === "FunctionExpression" && e[0].expression.arguments[0].params.length === 1 && e[0].expression.arguments[0].params[0].type === "Identifier" && e[0].expression.arguments[0].params[0].name === "require") {
                    ...
                    } else if (t.arguments[0] && t.arguments[0].type === "FunctionExpression" && t.arguments[0].params.length === 2 && t.arguments[0].params[0].type === "Identifier" && t.arguments[0].params[1].type === "Identifier" && "body" in t.callee && "body" in t.callee.body && Array.isArray(t.callee.body.body) && t.callee.body.body.length === 1) {
                        const e = t.callee.body.body[0];
                        if (e.type === "IfStatement" && e.test.type === "LogicalExpression" && e.test.operator === "&&" && e.test.left.type === "BinaryExpression" && e.test.left.left.type === "UnaryExpression" && e.test.left.left.operator === "typeof" && e.test.left.left.argument.type === "Identifier" && e.test.left.left.argument.name === "module" && e.test.left.right.type === "Literal" && e.test.left.right.value === "object" && e.test.right.type === "BinaryExpression" && e.test.right.left.type === "UnaryExpression" && e.test.right.left.operator === "typeof" && e.test.right.left.argument.type === "MemberExpression" && e.test.right.left.argument.object.type === "Identifier" && e.test.right.left.argument.object.name === "module" && e.test.right.left.argument.property.type === "Identifier" && e.test.right.left.argument.property.name === "exports" && e.test.right.right.type === "Literal" && e.test.right.right.value === "object" && e.consequent.type === "BlockStatement" && e.consequent.body.length > 0) {
                            let r;
                            if (e.consequent.body[0].type === "VariableDeclaration" && e.consequent.body[0].declarations[0].init && e.consequent.body[0].declarations[0].init.type === "CallExpression") r = e.consequent.body[0].declarations[0].init;
                            else if (e.consequent.body[0].type === "ExpressionStatement" && e.consequent.body[0].expression.type === "CallExpression") r = e.consequent.body[0].expression;
                            else if (e.consequent.body[0].type === "ExpressionStatement" && e.consequent.body[0].expression.type === "AssignmentExpression" && e.consequent.body[0].expression.operator === "=" && e.consequent.body[0].expression.right.type === "CallExpression") r = e.consequent.body[0].expression.right;
                            if (r && r.callee.type === "Identifier" && "params" in t.callee && t.callee.params.length > 0 && "name" in t.callee.params[0] && r.callee.name === t.callee.params[0].name && r.arguments.length === 2 && r.arguments[0].type === "Identifier" && r.arguments[0].name === "require" && r.arguments[1].type === "Identifier" && r.arguments[1].name === "exports") {
                                        ...
                                        if (o.type === "CallExpression" && o.callee.type === "Identifier" && "name" in r.params[2] && o.callee.name === r.params[2].name && o.arguments.length === 1 && o.arguments[0].type === "Literal") {
                                            ...
                                            if (r) {
                                                ...
                                                if ("right" in s && s.right === o) {
                                                    ...
                                                    s.callee = e;
                                                } else if ("arguments" in s && s.arguments.some((e)=>e === o)) {
                                                    s.arguments = s.arguments.map((t)=>t === o ? e : t);
                                                } else if ("init" in s && s.init === o) {
                                                    if (s.type === "VariableDeclarator" && s.id.type === "Identifier") t.set(s.id.name, r);
                                                    s.init = e;
                                                }
                                            }
                                        } else if (o.type === "CallExpression" && o.callee.type === "MemberExpression" && o.callee.object.type === "Identifier" && "name" in r.params[2] && o.callee.object.name === r.params[2].name && o.callee.property.type === "Identifier" && o.callee.property.name === "n" && o.arguments.length === 1 && o.arguments[0].type === "Identifier") {
        ...
        351: (e, t)=>{
            ...
            function abbrev(e) {
                ...
                for(var t = 0, r = s.length; t < r; t++){
                    var u = s[t], c = s[t + 1] || "", f = true, d = true;
                    if (u === c) continue;
        ...
        5478: (e, t, r)=>{
            ...
            function plugin(e) {
                return function(t) {
                    return pluginImpl(e, t);
                };
            }
            function pluginImpl(e, t) {
                const r = t.acorn || a;
                const { tokTypes: s, TokenType: p } = r;
                const { keyword: v } = e;
                const g = v.includes(c);
                const D = v.includes(f);
                const y = g && D;
                return class extends t {
                    constructor(...e){
                        super(...e);
                        this.withToken = g && new p(c);
                        this.assertToken = D && new p(f);
                    }
                    _codeAt(e) {
                    ...
                    _matchKeywordToken() {
                        return y && (this.type === this.withToken || this.type === this.assertToken) || g && this.type === this.withToken || D && this.type === this.assertToken;
                    }
                    _getProperty() {
                        if (y) {
                    ...
                    readToken(e) {
                        ...
                        let s;
                        if (y) {
                            if (this.input.slice(this.pos, this.pos + c.length) === c) {
                                r = c;
                                s = this.withToken;
                            } else if (this.input.slice(this.pos, this.pos + f.length) === f) {
                                r = f;
                                s = this.assertToken;
                            } else {
                            ...
                            r = g ? c : f;
                            s = g ? this.withToken : this.assertToken;
                            for(; t < r.length; t++){
                                if (this._codeAt(this.pos + t) !== r.charCodeAt(t)) {
                                    return super.readToken(e);
                                }
                            }
                        }
                    ...
                    parseExport(e, t) {
                        ...
                        if (this.eat(s._default)) {
                            ...
                            var r;
                            if (this.type === s._function || (r = this.isAsyncFunction())) {
                                var a = this.startNode();
                                this.next();
                                if (r) {
                                    this.next();
                                }
                                e.declaration = this.parseFunction(a, d | h, false, r);
                        ...
                        if (this.shouldParseExportStatement()) {
                            ...
                            if (this.eatContextual("from")) {
                                ...
                                for(var u = 0, c = e.specifiers; u < c.length; u += 1){
                                    var f = c[u];
                                    this.checkUnreserved(f.local);
                                    this.checkLocalExport(f.local);
                                }
                                e.source = null;
                            }
                            this.semicolon();
                    ...
                    parsewithEntries() {
                        ...
                        do {
                            ...
                            r.value = this.parseLiteral(this.value);
        ...
        878: (e)=>{
            ...
            var t = {
                ...
                O: {
                    label: "object",
                    check: function(e) {
                        return typeof e === "object" && e != null && !t.A.check(e) && !t.E.check(e);
                    }
                },
                B: {
                    label: "boolean",
            ...
            var r = e.exports = function(e, r) {
                ...
                if (!t.S.check(e)) throw invalidType(0, [
                    "string"
                ], e);
                if (!t.A.check(r)) throw invalidType(1, [
                    "array"
                ], r);
                var s = e.split("|");
                var a = {};
            ...
            function missingRequiredArg(e) {
                return newException("EMISSINGARG", "Missing required argument #" + (e + 1));
            }
            function unknownType(e, t) {
                return newException("EUNKNOWNTYPE", "Unknown type " + t + " in argument #" + (e + 1));
            }
            function invalidType(e, r, s) {
                ...
                return newException("EINVALIDTYPE", "Argument #" + (e + 1) + ": Expected " + englishList(r) + " but got " + a);
            }
            ...
            function wrongNumberOfArgs(e, t) {
                ...
                return newException("EWRONGARGCOUNT", "Expected " + r + " " + s + " but got " + t);
            }
            function moreThanOneError(e) {
                return newException("ETOOMANYERRORTYPES", 'Only one error type per argument signature is allowed, more than one found in "' + e + '"');
            }
        ...
        308: (e, t, r)=>{
            ...
            c.prototype.addUnit = function(e, t) {
                if (e.addUnit) {
                    ...
                    while(r){
                        if (e === r) {
                            throw new Error("Attempted to add tracker group " + e.name + " to tree that already includes it " + this.nameInTree(this));
                        }
                        r = r.parentGroup;
                    }
                    e.parentGroup = this;
                ...
                if (!this.finished) this.emit("change", e.name, this.completion[e.id], e);
                return e;
            };
        ...
        374: (e, t, r)=>{
            ...
            o(c.prototype, "tracker").method("completed").method("addWork").method("finish");
        },
        7605: (e, t, r)=>{
            "use strict";
            var s = r(3837);
        ...
        3331: (module, exports, __nccwpck_require__)=>{
            var fs = __nccwpck_require__(7147), path = __nccwpck_require__(1017), fileURLToPath = __nccwpck_require__(7121), join = path.join, dirname = path.dirname, exists = fs.accessSync && function(e) {
                try {
                    fs.accessSync(e);
                } catch (e) {
                    return false;
            ...
            function bindings(opts) {
                ...
                var requireFunc = ("TURBOPACK compile-time truthy", 1) ? eval("require") : ("TURBOPACK unreachable", undefined);
                var tries = [], i = 0, l = opts.try.length, n, b, err;
                for(; i < l; i++){
                    n = join.apply(null, opts.try[i].map(function(e) {
                        return opts[e] || e;
                    }));
                    tries.push(n);
                    try {
            ...
            exports.getFileName = function getFileName(e) {
                var t = Error.prepareStackTrace, r = Error.stackTraceLimit, s = {}, a;
            ...
            exports.getRoot = function getRoot(e) {
                ...
                while(true){
                    ...
                    if (exists(join(t, "package.json")) || exists(join(t, "node_modules"))) {
                        return t;
                    }
                    if (r === t) {
                        throw new Error('Could not find module root given file: "' + e + '". Do you have a `package.json` file? ');
                    }
                    r = t;
                    t = join(t, "..");
                }
        ...
        5719: (e, t, r)=>{
            ...
            const parse = (e, t = {})=>{
                ...
                if (e.length > w) {
                    throw new SyntaxError(`Input length (${e.length}), exceeds max characters (${w})`);
                }
                let x = {
                    type: "root",
                    input: e,
 ...
 */ const s = r(3837);
            ...
            const toSequence = (e, t, r)=>{
                ...
                if (e.positives.length) {
                    a = e.positives.map((e)=>toMaxLen(String(e), r)).join("|");
                }
            ...
            const rangeError = (...e)=>new RangeError("Invalid range arguments: " + s.inspect(...e));
            ...
            const fillNumbers = (e, t, r = 1, s = {})=>{
                ...
                if (!Number.isInteger(a) || !Number.isInteger(o)) {
                    if (s.strictRanges === true) throw rangeError([
                        e,
                        t
                    ]);
                    return [];
                ...
                if (s.toRegex === true) {
                    return r > 1 ? toSequence(D, s, h) : toRegex(y, null, {
                        wrap: false,
                        ...s
                    });
                }
        ...
        287: (e, t, r)=>{
            ...
            function Gauge(e, t) {
                ...
                this._fixedFramerate = r.fixedFramerate == null ? !/^v0\.8\./.test(d.version) : r.fixedFramerate;
            ...
            Gauge.prototype._computeTheme = function(e) {
                ...
                } else if (e && (Object.keys(e).length === 0 || e.hasUnicode != null || e.hasColor != null)) {
            ...
            Gauge.prototype.setWriteTo = function(e, t) {
                ...
                if (r) this.disable();
                this._writeTo = e;
                this._tty = t || e === d.stderr && d.stdout.isTTY && d.stdout || e.isTTY && e || this._tty;
        ...
        4052: (e, t, r)=>{
            ...
            u.prototype.show = function(e) {
                ...
                return a(this.width, this.template, t).trim() + s.color("reset") + s.eraseLine() + s.gotoSOL();
            };
        },
        5751: (e)=>{
            "use strict";
        ...
        2964: (e, t, r)=>{
            ...
            e.exports = function(e, t, r) {
                ...
                var c = [
                    {
                        type: "complete",
                        value: repeat(e.complete, o),
                        length: o
                    },
                    {
                        type: "remaining",
                        value: repeat(e.remaining, u),
                        length: u
                    }
                ];
                return a(t, c, e);
        ...
        7238: (e, t, r)=>{
            ...
            function prepareItems(e, t, r) {
                ...
                function finishSizing(e, t) {
                    if (e.finished) throw new c.Internal("Tried to finish template item that was already finished");
                    if (t === Infinity) throw new c.Internal("Length of template item cannot be infinity");
                    ...
                    if (e.length == null) throw new c.Internal("Finished template items must have a length");
                ...
                if (p) throw new c.Internal("Resize loop iterated too many times while determining maxLength");
                d = 0;
                do {
                    p = false;
                    h = Math.round(o / u);
                ...
                if (p) throw new c.Internal("Resize loop iterated too many times while determining minLength");
                h = Math.round(o / u);
                s.forEach(function(e) {
                    if (e.finished) return;
                    finishSizing(e, h);
            ...
            function renderValue(e, t) {
                ...
                var a = typeof e.value === "function" ? renderFunction(e, t, r) : e.value;
                if (a == null || a === "") return "";
        ...
        8855: (e, t, r)=>{
            ...
            TemplateItem.prototype.getBaseLength = function() {
                var e = this.length;
                if (e == null && typeof this.value === "string" && this.maxLength == null && this.minLength == null) {
                    e = s(this.value);
                }
                return e;
            };
        ...
        8469: (e, t, r)=>{
            ...
            a.setDefault = function(e, t) {
                ...
                var s = !!e.hasUnicode;
                var a = !!e.hasColor;
                if (!this.defaults[r]) this.defaults[r] = {
                    true: {},
                    false: {}
                };
            ...
            a.newMissingDefaultThemeError = function newMissingDefaultThemeError(e, t, r) {
                var s = new Error("Could not find a gauge theme for your platform/unicode/color use combo:\n" + "    platform = " + e + "\n" + "    hasUnicode = " + t + "\n" + "    hasColor = " + r);
        ...
        6450: (e, t, r)=>{
            ...
            else if (/\bgfs4\b/i.test(process.env.NODE_DEBUG || "")) p = function() {
            ...
            if (!s[f]) {
                ...
                s.closeSync = function(e) {
                    ...
                    Object.defineProperty(closeSync, d, {
                        value: e
                    });
                    return closeSync;
                }(s.closeSync);
            ...
            function patch(e) {
                ...
                function writeFile(e, t, s, a) {
                    ...
                    function go$writeFile(e, t, s, a, o) {
                        return r(e, t, s, function(r) {
                            if (r && (r.code === "EMFILE" || r.code === "ENFILE")) enqueue([
                                go$writeFile,
                                [
                                    e,
                                    t,
                ...
                function copyFile(e, t, r, s) {
                    ...
                    function go$copyFile(e, t, r, s, a) {
                        return u(e, t, r, function(o) {
                            if (o && (o.code === "EMFILE" || o.code === "ENFILE")) enqueue([
                                go$copyFile,
                                [
                                    e,
                                    t,
                ...
                function readdir(e, t, r) {
                    ...
                    var s = f.test(process.version) ? function go$readdir(e, t, r, s) {
                ...
                if (u === "win32") {
                    e.rename = typeof e.rename !== "function" ? e.rename : function(t) {
                        function rename(r, s, a) {
                            ...
                            var u = 0;
                            t(r, s, function CB(c) {
                                if (c && (c.code === "EACCES" || c.code === "EPERM" || c.code === "EBUSY") && Date.now() - o < 6e4) {
                                    setTimeout(function() {
        ...
        3279: (e, t, r)=>{
            ...
            e.exports = function(e) {
                ...
                if (e >= 4352 && (e <= 4447 || 9001 === e || 9002 === e || 11904 <= e && e <= 12871 && e !== 12351 || 12880 <= e && e <= 19903 || 19968 <= e && e <= 42182 || 43360 <= e && e <= 43388 || 44032 <= e && e <= 55203 || 63744 <= e && e <= 64255 || 65040 <= e && e <= 65049 || 65072 <= e && e <= 65131 || 65281 <= e && e <= 65376 || 65504 <= e && e <= 65510 || 110592 <= e && e <= 110593 || 127488 <= e && e <= 127569 || 131072 <= e && e <= 262141)) {
                    return true;
                }
                return false;
            };
 ...
 */ e.exports = function(e) {
        ...
        5850: (module, __unused_webpack_exports, __nccwpck_require__)=>{
            ...
            var runtimeRequire = ("TURBOPACK compile-time truthy", 1) ? eval("require") : ("TURBOPACK unreachable", undefined);
            ...
            load.resolve = load.path = function(e) {
                e = path.resolve(e || ".");
                try {
                    var t = runtimeRequire(path.join(e, "package.json")).name.toUpperCase().replace(/-/g, "_");
                ...
                var u = [
                    ...
                    ("TURBOPACK compile-time truthy", 1) ? "webpack=true" : ("TURBOPACK unreachable", undefined)
                ].filter(Boolean).join(" ");
        ...
        1758: (e, t, r)=>{
            var s = process.env.DEBUG_NOPT || process.env.NOPT_DEBUG ? function() {
                console.error.apply(console, arguments);
            } : function() {};
            var a = r(7310), o = r(1017), u = r(2781).Stream, c = r(351), f = r(2037);
            e.exports = t = nopt;
            t.clean = clean;
            t.typeDefs = {
                String: {
            ...
            function clean(e, r, a) {
                ...
                Object.keys(e).forEach(function(c) {
                    if (c === "argv") return;
                    var f = e[c], d = Array.isArray(f), p = r[c];
                    if (!d) f = [
                        f
                    ];
                    if (!p) p = u;
                    ...
                    f = f.map(function(u) {
                        if (typeof u === "string") {
                            s("string %j", u);
                            u = u.trim();
                            if (u === "null" && ~p.indexOf(null) || u === "true" && (~p.indexOf(true) || ~p.indexOf(Boolean)) || u === "false" && (~p.indexOf(false) || ~p.indexOf(Boolean))) {
                                u = JSON.parse(u);
                                s("jsonable %j", u);
                        ...
                        if (u === false && ~p.indexOf(null) && !(~p.indexOf(false) || ~p.indexOf(Boolean))) {
                            u = null;
                        }
                        var f = {};
                        f[c] = u;
            ...
            function validatePath(e, t, r) {
                ...
                r = String(r);
                var s = process.platform === "win32", a = ("TURBOPACK compile-time truthy", 1) ? /^~(\/|\\)/ : ("TURBOPACK unreachable", undefined), u = f.homedir();
                if (u && r.match(a)) {
            ...
            function validate(e, t, r, a, o) {
                ...
                var f = false, d = Object.keys(o);
                for(var u = 0, c = d.length; u < c; u++){
                    s("test type %j %j %j", t, r, d[u]);
                    var p = o[d[u]];
                    if (p && (a && a.name && p.type && p.type.name ? a.name === p.type.name : a === p.type)) {
                        var h = {};
            ...
            function parse(e, t, r, a, o) {
                s("parse", e, t, r);
                var u = null, f = c(Object.keys(a)), d = c(Object.keys(o));
                for(var p = 0; p < e.length; p++){
                    ...
                    if (h.charAt(0) === "-" && h.length > 1) {
                        ...
                        var x, C = e[p + 1];
                        var F = typeof m === "boolean" || _ === Boolean || E && _.indexOf(Boolean) !== -1 || typeof _ === "undefined" && !v || C === "false" && (_ === null || E && ~_.indexOf(null));
                        if (F) {
                            x = !m;
                            if (C === "true" || C === "false") {
                                x = JSON.parse(C);
                            ...
                            if (E && C) {
                                if (~_.indexOf(C)) {
                                    ...
                                    x = null;
                                    p++;
                                } else if (!C.match(/^-{2,}[^-]/) && !isNaN(C) && ~_.indexOf(Number)) {
                                    x = +C;
                                    p++;
            ...
            function resolveShort(e, t, r, a) {
                ...
                if (u.join("") === e) return u.map(function(e) {
                    return t[e];
                }).reduce(function(e, t) {
                    return e.concat(t);
                }, []);
        ...
        9544: (e, t, r)=>{
            ...
            u.log = (function(e, t, r) {
                var s = this.levels[e];
                if (s === undefined) {
                    return this.emit("error", new Error(c.format("Undefined log level: %j", e)));
                }
            ...
            u.levels = {};
            u.disp = {};
            u.addLevel("silly", -Infinity, {
                inverse: true
            }, "sill");
            u.addLevel("verbose", 1e3, {
                fg: "blue",
                bg: "black"
            }, "verb");
            u.addLevel("info", 2e3, {
...
*/ var t = Object.getOwnPropertySymbols;
            ...
            e.exports = shouldUseNative() ? Object.assign : function(e, a) {
                var o;
                var u = toObject(e);
                var c;
        ...
        5502: (e, t, r)=>{
            ...
            const { REGEX_BACKSLASH: o, REGEX_REMOVE_BACKSLASH: u, REGEX_SPECIAL_CHARS: c, REGEX_SPECIAL_CHARS_GLOBAL: f } = r(7798);
        ...
        7355: (e, t, r)=>{
            ...
            function readableAddChunk(e, t, r, s, a) {
                ...
                if (t === null) {
                    ...
                    if (u) {
                        ...
                        if (typeof t !== "string" && !o.objectMode && Object.getPrototypeOf(t) !== f.prototype) {
            ...
            Readable.prototype.pipe = function(e, t) {
                ...
                var o = (!t || t.end !== false) && e !== process.stdout && e !== process.stderr;
                ...
                function cleanup() {
                    ...
                    f = true;
                    if (a.awaitDrain && (!e._writableState || e._writableState.needDrain)) c();
                }
                var d = false;
                r.on("data", ondata);
                function ondata(t) {
                    ...
                    var s = e.write(t);
                    if (false === s && !d) {
                        if ((a.pipesCount === 1 && a.pipes === e || a.pipesCount > 1 && indexOf(a.pipes, e) !== -1) && !f) {
        ...
        2162: (e, t, r)=>{
            ...
            Transform.prototype._write = function(e, t, r) {
                ...
                if (!s.transforming) {
                    var a = this._readableState;
                    if (s.needTransform || a.needReadable || a.length < a.highWaterMark) this._read(a.highWaterMark);
                }
            };
        ...
        3517: (e, t, r)=>{
            ...
            var a = !("TURBOPACK compile-time value", false) && [
                "v0.10",
                "v0.9."
            ].indexOf(process.version.slice(0, 5)) > -1 ? setImmediate : s.nextTick;
            var o;
        ...
        2382: (e, t, r)=>{
            ...
            const resolveFrom = (e, t, r)=>{
                ...
                if (typeof t !== "string") {
                    throw new TypeError(`Expected \`moduleId\` to be of type \`string\`, got \`${typeof t}\``);
                }
                try {
                    e = o.realpathSync(e);
                } catch (t) {
                ...
                const resolveFileName = ()=>a._resolveFilename(t, {
                        id: u,
                        filename: u,
        ...
        4700: (e, t, r)=>{
            ...
            const rimraf = (e, t, r)=>{
                ...
                const afterGlob = (e, s)=>{
                    ...
                    s.forEach((e)=>{
                        const CB = (r)=>{
                            if (r) {
                                if ((r.code === "EBUSY" || r.code === "ENOTEMPTY" || r.code === "EPERM") && a < t.maxBusyTries) {
                                    a++;
                ...
                if (t.disableGlob || !u.hasMagic(e)) return afterGlob(null, [
                    e
                ]);
                t.lstat(e, (r, s)=>{
                    if (!r) return afterGlob(null, [
                        e
                    ]);
                ...
                t.lstat(e, (s, a)=>{
                    ...
                    t.unlink(e, (s)=>{
                        if (s) {
                            ...
                            if (s.code === "EPERM") return ("TURBOPACK compile-time truthy", 1) ? fixWinEPERM(e, t, s, r) : ("TURBOPACK unreachable", undefined);
            ...
            const rmdir = (e, t, r, a)=>{
                ...
                s(typeof a === "function");
                t.rmdir(e, (s)=>{
                    if (s && (s.code === "ENOTEMPTY" || s.code === "EEXIST" || s.code === "EPERM")) rmkids(e, t, a);
            ...
            const rimrafSync = (e, t)=>{
                ...
                for(let e = 0; e < r.length; e++){
                    ...
                    try {
                        ...
                        if (e.code === "ENOENT") return;
                        if (e.code === "EPERM") return ("TURBOPACK compile-time truthy", 1) ? fixWinEPERMSync(s, t, e) : ("TURBOPACK unreachable", undefined);
            ...
            const rmdirSync = (e, t, r)=>{
                ...
                try {
                    ...
                    if (s.code === "ENOTEMPTY" || s.code === "EEXIST" || s.code === "EPERM") rmkidsSync(e, t);
                }
            };
            const rmkidsSync = (e, t)=>{
                ...
                const r = ("TURBOPACK compile-time truthy", 1) ? 100 : ("TURBOPACK unreachable", undefined);
                let o = 0;
                do {
                    let s = true;
                    try {
        ...
        2656: (e)=>{
            e.exports = function(e) {
                [
                    ...
                    if (t._handle && t.isTTY && typeof t._handle.setBlocking === "function") {
        ...
        4426: (e, t, r)=>{
            ...
            function normalizeEncoding(e) {
                ...
                if (typeof t !== "string" && (s.isEncoding === a || !a(e))) throw new Error("Unknown encoding: " + e);
                return t || e;
            }
            t.s = StringDecoder;
 ...
 */ const s = r(3357);
            ...
            function zip(e, t) {
                let r = [];
                for(let s = 0; s < e.length; s++)r.push([
                    e[s],
                    t[s]
                ]);
                return r;
        ...
        2081: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[externals]/child_process [external] (child_process, cjs)");
        },
        2057: (e)=>{
            "use strict";
        ...
        8188: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[externals]/module [external] (module, cjs)");
        },
        1988: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/acorn/acorn.js [app-rsc] (ecmascript)");
        },
        5749: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/async-sema/index.js [app-rsc] (ecmascript)");
        },
        3535: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/glob/glob.js [app-rsc] (ecmascript)");
        },
        3423: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/picomatch/index.js [app-rsc] (ecmascript)");
        },
        7849: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/semver/index.js [app-rsc] (ecmascript)");
        },
        7518: (e)=>{
            "use strict";
            e.exports = __turbopack_context__.r("[project]/node_modules/next/dist/compiled/strip-ansi/index.js [app-rsc] (ecmascript)");
        },
        2037: (e)=>{
            "use strict";
        ...
        9663: (e, t, r)=>{
            ...
            class Scope {
                ...
                contains(e) {
                    return this.declarations[e] || (this.parent ? this.parent.contains(e) : false);
                }
            }
            ...
            const v = function createFilter(e, t, r) {
                const s = r && r.resolve;
                const getMatcher = (e)=>e instanceof RegExp ? e : {
                        test: (t)=>{
            ...
            const g = "break case class catch const continue debugger default delete do else export extends finally for function if import in instanceof let new return super switch this throw try typeof var void while with yield enum await implements package protected static interface private public";
            const D = "arguments Infinity NaN undefined null true false eval uneval isFinite isNaN parseFloat parseInt decodeURI decodeURIComponent encodeURI encodeURIComponent escape unescape Object Function Boolean Symbol Error EvalError InternalError RangeError ReferenceError SyntaxError TypeError URIError Number Math Date String RegExp Array Int8Array Uint8Array Uint8ClampedArray Int16Array Uint16Array Int32Array Uint32Array Float32Array Float64Array Map Set WeakMap WeakSet SIMD ArrayBuffer DataView JSON Promise Generator GeneratorFunction Reflect Proxy Intl";
            const y = new Set(`${g} ${D}`.split(" "));
            y.add("");
            const m = function makeLegalIdentifier(e) {
                let t = e.replace(/-(\w)/g, (e, t)=>t.toUpperCase()).replace(/[^$_a-zA-Z0-9]/g, "_");
            ...
            function stringify(e) {
                return (JSON.stringify(e) || "undefined").replace(/[\u2028\u2029]/g, (e)=>`\\u${`000${e.charCodeAt(0).toString(16)}`.slice(-4)}`);
            }
            ...
            const _ = function dataToEsm(e, t = {}) {
                ...
                if (t.namedExports === false || typeof e !== "object" || Array.isArray(e) || e instanceof Date || e instanceof RegExp || e === null) {
                ...
                for (const [f, d] of Object.entries(e)){
                    if (f === m(f)) {
                        ...
                        c.push(`${stringify(f)}:${s}${serialize(d, t.compact ? null : r, "")}`);
                    }
                }
    ...
    var __webpack_exports__ = __nccwpck_require__(2787);
...
//# sourceMappingURL=node_modules_next_dist_compiled_%40vercel_nft_f13541bb._.js.map