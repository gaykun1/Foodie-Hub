...
async function checkAuth() {
    ...
    const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:5200")}/api/auth/profile`, {
        method: "GET",
        credentials: "include",
        headers: {
...
async function RootLayout({ children }) {
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["checkAuth"])();
    console.log(user);
    if (!user) {
...
//# sourceMappingURL=src_ad4b31a1._.js.map