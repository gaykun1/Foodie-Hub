...
import { checkIfHasOrder, checkIfSentApplication, createApplication, getApplications, profile, takeOrder, toggleApplication } from "../controllers/courierController";
